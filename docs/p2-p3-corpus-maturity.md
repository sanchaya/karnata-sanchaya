...
| --- | ---: | --- |
| `genealogicalRelations` | 28 | Derived or secondary assertions; the Hoysala, Wadiyar, Western Ganga and Kadamba long bridges are split into individual-generation links, with Vengi, Tuluva-line and new Kalyani Chalukya closure links — none are final family-tree proof |
| `feudatoryRelations` / `administrativeDivisions` | 9 / 6 | Samanta/successor links now cover Western Ganga, Alupa, Hoysala, Keladi, Chitradurga Nayaka and Bahmani-Adil Shahi contexts; administrative geography adds Gangavadi, Banavasi, Raichur Doab, Tirhut, Lakkundi and Bahmani north-Karnataka schematic zones |
| `coinRecords` | 12 | 8 leads have located catalogue/metal/weight gates from specialist catalogues or honest type-level contexts; new Kadamba Banavasi and Bahmani Bidar-Kalaburagi packets close graph gaps but remain unresolved catalogue leads. Image and findspot gates stay open across the collection |
| `manuscriptWitnesses` | 16 | 7 witnesses have real Internet Archive editions, two dead CESCK leads are downgraded/recovery-queued, and new Gadayuddha/Vaddaradhane closure packets keep priority works visible while base editions and shelfmarks are resolved |
| `boundaryEvidence` | 11 | Schematic evidence packets now include Lakkundi/Kalyani Chalukya and Bahmani north-Karnataka administrative zones, in addition to Hoysala, Tipu, Vijayanagara, Rashtrakuta and Western Ganga packets. Each still retains blockers, usually source-map comparison or administrative-unit locators |
| `inscriptionEditions` | 30 | Item-edition queue now includes Gudnapur Kadamba and Doddahundi nishidhi packets alongside Halmidi, Talagunda, Kappe Arabhatta, Begur, Atakur, Lakkundi, Belur, Muktesvara, Hampi and Shravanabelagola records; transcription, translation, photographs and coordinates mostly open |
...
A second pass closed evidence gates on three more boundary packets:

| Record | What's now located |
| --- | --- |
| `boundary-evidence-vijayanagara-krishnadevaraya-core-1520` | Administrative-unit evidence (the Rajya-Kottam/Sime-Kampana provincial hierarchy and amaranayaka land-grant system) and inscription-cluster evidence (the Hampi inscription cluster, the imperial capital under Krishnadevaraya). |
| `boundary-evidence-rashtrakuta-amoghavarsha-850` | Inscription-cluster evidence (the 872 CE Sanjan copper-plate inscription recording homage from Anga, Vanga, Magadha and the Pallavas of Kanchi); administrative-units still blocked since this is prestige/tribute evidence, not a direct administrative record. |
| `boundary-evidence-rashtrakuta-kannauj-campaign-circa-800` | Opponent-polity-sources evidence, reusing the Nagabhata II/Dharmapala/Chakrayudha research already done for the linked political-relation record — this closes all gates except source-map-comparison. |
| `boundary-evidence-western-ganga-core-prototype` | Administrative-unit evidence: the Rashtra-Visaya/Nadu-Desa hierarchy, with the core territory known as Gangavadi-96000 (96 Nadus) from 725 CE, covering roughly modern Mysuru/Mandya/Chamarajanagar. This closes all gates except source-map-comparison. |
...
The P2 research-graph closure sprint adds the remaining cross-stream scaffolding needed for exploration: Kalyani Chalukya genealogy links, Chitradurga/Bahmani successor-feudatory packets, Lakkundi and Bahmani administrative zones, two new boundary packets, Kadamba/Bahmani coinage leads, Gadayuddha/Vaddaradhane manuscript queue records, Gudnapur/Doddahundi inscription-edition packets and six source-backed district-history candidates. This closes the software/data-graph expansion goal, not the scholarly review goal.
...
| `edition-inscription-talagunda` | Matched to Epigraphia Carnatica Vol. VII (Shikaripur taluk) item **Sk. 176**: the 46-line Kadamba genealogy pillar (Shantivarman era, c. 455-470 CE) that underpins this atlas's Kadamba genealogy split, also edited by Kielhorn in Epigraphia Indica. | Check the printed plate, cross-check against Kielhorn's edition, complete transcription/translation and attach dated photographs. |
| `edition-inscription-kappe-arabhatta` | Matched to **I.A. X.61** (Indian Antiquary Vol. X, the "Tattukoti Inscription"): five stanzas cut into a cliff at Badami lake, the earliest recorded Kannada tripadi-metre verses; discussed in A. N. Narasimhia's 1941 grammar of the oldest Kannada inscriptions. | Check the printed plate, cross-check against Narasimhia's grammar, complete a line-aligned transcription/translation of all five stanzas and attach dated photographs. |
| `edition-inscription-begur` | Matched to **Epigraphia Carnatica Vol. IX Supplement, Bg. 174** (c. 900 CE): the earliest known written reference to "Bengaluru" (bengulura kalage), commemorating Pervvonashetti and Buttanapati, sons of the chieftain Nagattara; the stone stands in the Panchalingeshwara temple, Begur. | Check the printed EC volume, complete transcription/translation and attach dated photographs. |
| `edition-inscription-atakur` | Content and date located (Saka 872 / 949-950 CE hero-stone at the Chelleshvara temple, Atakur, recording the hound Kali's fight with a boar alongside Krishna III's Takkolam victory over the Cholas); likely EC Vol. XIV ("Md" taluk prefix) but the exact item number is not yet confirmed, so `itemEdition.status` stays `provisional`. | Confirm the exact EC Vol. XIV item number, then check the printed plate and complete transcription/translation. |
...
| `manuscript-ajitapurana-jangamwadi-witness-lead` (new) | N. Sannayya Rama Gauda's edition of Ranna's Ajitapurana, Jangamwadi Math Library Collection, freely downloadable. Linked to `work-ajitapurana`, whose `workDate` was also tightened to `year`/993 (exact composition year) — all 6 `reviewWorkflow` evidence gates for this work are now `located`. | Confirm licence status; independent scholarly review. |
| `manuscript-shantipurana-jangamwadi-witness-lead` (new) | Dr. S. Vidyashankar's edition of Ponna's Shantipurana, explicitly CC0-licensed, freely downloadable; `license` gate moved to `located` (not just `provisional`) given the explicit public-domain dedication. Linked to `work-shantipurana`, now 5 of 6 evidence gates located. | Independent scholarly review. |
