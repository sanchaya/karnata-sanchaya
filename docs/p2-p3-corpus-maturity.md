...
| `boundaryEvidence` | 9 | Schematic evidence packets, including new Chalukya inscription-cluster and Keladi coastal-interior administrative packets; 6 of 9 packets now have sourced inscription, campaign, treaty or administrative-unit evidence for some gates (Hoysala x2, Tipu, Vijayanagara/Krishnadevaraya, Rashtrakuta x2); each still blocked on at least a reign-specific source map. Western Ganga core, the Chalukya/Aihole cluster and the Keladi admin-zone packets remain untouched by this pass; not research-grade boundary corpus |
