...
| Atlas v0.12 — district heritage audit | **Statewide inventory and connections delivered; verification incomplete** | 31 district audit coverage, map boundaries, public UNESCO/national/state/local/research filters, register IDs, 1,531 inventory leads and contextual history links across every district. The first eight-district batch has 16/16 site/locality points and no district-centre fallback | Replace the six approximate/locality/settlement/precinct points with surveyed monument points; resolve authority, licences, dated condition and managing authority before promotion |
| Atlas v0.15 — Literature and Epigraphy Explorer | **Software achieved; witness-linking advanced; human review incomplete** | Literature/epigraphy pages, maps, timeline links, Bengaluru exception and review-gated candidates. All 16 registered manuscript/edition witnesses are now linked back to their 10 corresponding works, and located repository records supply review citations without being mistaken for independent verification | Locate editions or manuscript witnesses for the remaining 15 works; independently verify all 25 literary packets, and complete Sannati/Maski transcription and Kannada review |
...
| Atlas v0.22 — early Karnataka and regional-polity research wave | **Structured first pass and guided-trail enrichment delivered; human review open** | Pre-Kadamba archaeological and Mauryan epigraphic narrative; Alupa polity/inscription packet; Keladi–Ikkeri and Chitradurga governance modules; seven Kadamba/Ganga/Kalyani Chalukya reigns; citations for all previously uncited major rulers; four source-backed schematic territorial records; candidate packets for all 22 previously empty districts. The public explorer now has 18 trails with 144 stops; the seven newer trails include existing coin, ruler, administration, inscription, capital and boundary-evidence records where available | Resolve primary edition locators, individual reign dates, coastal inscriptions, catalogue-level coin evidence, district authority evidence and exact territorial reconstruction before promoting records |
...
The literature collection contains 25 linked works, but independent review is not complete. All 16 registered manuscript, print or digital-edition witnesses now link back to 10 works and make those repository records and citations visible inside their review packets. A located witness remains a blocker until its attribution, dating, item identity and bilingual interpretation are independently verified; validation now enforces that distinction. Fifteen works still need an edition or manuscript witness to be located. The relationship graph has 1,639 records, including clearly labeled district/heritage context links. Xuanzang, Barus and Polonnaruwa strengthen the China, Southeast Asia and Sri Lanka corridors; Malaysia and Singapore remain explicitly unresolved research leads pending item-level Karnataka evidence.
...
5. Complete field evidence for the first district heritage batch: all 16 candidates are mapped without district-centre fallbacks, but six coordinates need surveyed replacement and all 16 still need authority-confirmed present-condition packets.
