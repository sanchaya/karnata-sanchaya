...
| Atlas v0.21 — India political-relations pass | **Schema and first matrix pass delivered; research incomplete** | First-class bilateral relation records with parties, relation type, dates, routes, battle locations, outcomes, people, treaty-document placeholders, citations and explicit needs-review status; Deccan–Tamil–Kakatiya–Bahmani, northern/eastern, Maratha, Nizam, British, French and Portuguese seed coverage is connected to `#relations` and admin. The Rashtrakuta–Pratihara–Pala Kannauj contest is now resolved to campaign-level detail: three new commander/ruler person records (Nagabhata II, Dharmapala, Chakrayudha), three named battle locations (Kannauj, Munger, the Doab) and a sourced sequence outcome — 5 of 6 review-checklist items located (only treaty-or-document-witness remains unresolved; no treaty exists for this campaign) | Resolve campaign-level sources, exact battle geography, treaty witnesses, commanders and outcomes for the remaining ~27 relations; expand the remaining north/east/south and colonial relations |
...
- 26 genealogy assertions (Hoysala, Wadiyar, Western Ganga and Kadamba long bridges now split into individual-generation links; the Kadamba split is inscription-attested via the Talagunda pillar), 10 coin records (all 6 P1-model-foundations leads now have located catalogue/metal/weight gates), 12 manuscript witnesses, 9 boundary-evidence packets, 28 inscription-edition packets (three new Shravanabelagola item-level splits, plus located Belur Bl. 68 and Muktesvara S.I.I. XVIII No. 112 items) and 12 script-evolution records, all review-gated;
...
- 67 district deep-history records: 31 district scopes plus 36 research leads. The 22 districts that previously had no candidate now each have one explicit intake packet; Maski and Brahmagiri add source-backed Ashokan-script district packets, Ballari now has a source-backed Sanganakallu-Kupgal Neolithic-complex candidate with real coordinates and an archaeological-journal citation, Kolar now has a source-backed candidate for its Western Ganga founding-capital identity (Kuvalala/Kolahalapura, c. 350 CE), and all remain `needs-review` until site-level authority evidence is collected.

The literature collection contains 25 linked works, but the 24-packet review pass is not complete; two works (Kumaravyasa Bharata, Torave Ramayana) now have new creator-authority person records (Kumaravyasa, Kumara Valmiki), item-level print-edition citations and linked manuscript witnesses, moving their creatorIdentity, itemCitation and editionWitness evidence gates to located. Twelve manuscript, print or digital-edition witness leads now cover priority literary streams; their remaining attribution, dating, bilingual interpretation and independent-review gates stay open. The relationship graph has 1,639 records, including clearly labeled district/heritage context links. Xuanzang, Barus and Polonnaruwa strengthen the China, Southeast Asia and Sri Lanka corridors; Malaysia and Singapore remain explicitly unresolved research leads pending item-level Karnataka evidence.
