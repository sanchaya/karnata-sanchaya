...
- 9 Karnataka polities, 53 external polities with 53 map-ready capital/context-centre links, 104 events, 463 curated people, a 905-record lazy Wikimedia people-review candidate corpus and 28 bilateral political relations;
- 33 inscriptions, 25 literary works, 63 cultural records and 24 reign/period records;
- 325 sources, 1,624 generated relationships, 139 places and 13 collaboration records;
- 3,715 Patrika Sanchaya periodicals and 76 grouped publication-place anchors, all visibly `needs-review`;
- 9 genealogy assertions, 10 coin records, 9 manuscript witnesses, 9 boundary-evidence packets, 23 inscription-edition packets and 12 script-evolution records, all review-gated;
...
The literature collection contains 25 linked works, but the 24-packet review pass is not complete. Nine works now have manuscript, print or digital-edition witness leads; their remaining attribution, dating, bilingual interpretation and independent-review gates stay open. The relationship graph has 1,624 records, including clearly labeled district/heritage context links. Xuanzang, Barus and Polonnaruwa strengthen the China, Southeast Asia and Sri Lanka corridors; Malaysia and Singapore remain explicitly unresolved research leads pending item-level Karnataka evidence.
