...
| District Deep History / `#district-history` | **All districts seeded; research ongoing** | 31 district scope slots, 34 needs-review leads covering every district plus one source-backed site-level candidate (Ballari/Sanganakallu-Kupgal Neolithic complex, coordinates and archaeological-journal citation), map/filter/detail view, admin collection and validation | Replace remaining district-centroid intake leads with site-level prehistoric, settlement, foundation-stone and locality records |
