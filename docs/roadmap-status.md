...
| Atlas v0.21 — India political-relations pass | **Schema and first matrix pass delivered; research incomplete** | First-class bilateral relation records with parties, relation type, dates, routes, battle locations, outcomes, people, treaty-document placeholders, citations and explicit needs-review status; Deccan–Tamil–Kakatiya–Bahmani, northern/eastern, Maratha, Nizam, British, French and Portuguese seed coverage is connected to `#relations` and admin. Two relations are now resolved to campaign-level detail with 5 of 6 review-checklist items located (only treaty-or-document-witness stays unresolved, since neither campaign left a treaty): the Rashtrakuta–Pratihara–Pala Kannauj contest (Nagabhata II, Dharmapala, Chakrayudha; battle locations Kannauj/Munger/the Doab) and the Bahmani–Vijayanagara Raichur Doab contest's 1520 battle (Saluva Timmarusu's field command, Portuguese gunners under Christovao de Figueiredo, Ismail Adil Shah's defeat) | Resolve campaign-level sources, exact battle geography, treaty witnesses, commanders and outcomes for the remaining ~26 relations; expand the remaining north/east/south and colonial relations |
...
- 69 district deep-history records: 31 district scopes plus 38 research leads. The 22 districts that previously had no candidate now each have one explicit intake packet; Maski and Brahmagiri add source-backed Ashokan-script district packets, Ballari now has a source-backed Sanganakallu-Kupgal Neolithic-complex candidate with real coordinates and an archaeological-journal citation, Kolar now has a source-backed candidate for its Western Ganga founding-capital identity (Kuvalala/Kolahalapura, c. 350 CE), Tumakuru now has a source-backed candidate for the Kaidala Chennakeshava/Gangadhareshwara foundation inscription (1150-1151 CE), Haveri now has a source-backed candidate for the Siddheshwara temple (1087/1108 CE inscriptions), and all remain `needs-review` until site-level authority evidence is collected.
