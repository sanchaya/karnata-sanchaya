...
import { additionalInscriptions, additionalWorks, inscriptionDistrictAssignments, inscriptionPlaces, literaryPeople, literatureEpigraphySources, priorityInscriptionCandidates } from './literature-inscriptions.js'
...
export const atlasData = {
  ...
  ].map(([id,en,kn,polityId,role='ruler'])=>({ id:`person-${id}`, name:name(en,kn), roles:[role], date:{ from:null,to:null,era:'CE',precision:'unknown' }, citations:[], review:review('needs-review'), polityId })),
  inscriptions: [
