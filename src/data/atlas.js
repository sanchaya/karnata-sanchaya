...
export const atlasData = {
  ...
  sources: [
    ...
    { id: 'src-coinindia-vijayanagara-gallery', type: 'numismatic-catalogue', title: name('The COININDIA Coin Galleries: Vijayanagara Empire', 'ದಿ ಕಾಯಿನ್‌ಇಂಡಿಯಾ ನಾಣ್ಯ ಗ್ಯಾಲರಿಗಳು: ವಿಜಯನಗರ ಸಾಮ್ರಾಜ್ಯ'), authors: ['Sanjeev Kumar (CoinIndia)'], year: null, url: 'https://coinindia.com/galleries-vijayanagar.html', scope: name('Specialist numismatic reference giving weight, diameter, obverse/reverse iconography and Mitchiner (MSI) catalogue numbers for photographed Vijayanagara gold pagoda, half-pagoda and quarter-pagoda specimens. Dynasty/type-level reference; not yet matched to a Hampi-mint specimen or independently reviewed.', 'ವಿಜಯನಗರ ಚಿನ್ನದ ಪಗೋಡ, ಅರ್ಧ-ಪಗೋಡ ಮತ್ತು ಕಾಲು-ಪಗೋಡ ಮಾದರಿಗಳ ತೂಕ, ವ್ಯಾಸ, ಮುಖ/ಹಿಂಭಾಗದ ರೂಪಕ ಮತ್ತು ಮಿಚಿನರ್ (MSI) ಪಟ್ಟಿ ಸಂಖ್ಯೆಗಳನ್ನು ನೀಡುವ ವಿಶೇಷಜ್ಞ ನಾಣ್ಯಶಾಸ್ತ್ರ ಆಕರ. ವಂಶ/ಬಗೆ-ಮಟ್ಟದ ಆಕರ; ಇನ್ನೂ ಹಂಪಿ-ಟಂಕಶಾಲೆ ಮಾದರಿಗೆ ಹೊಂದಿಸಿಲ್ಲ ಅಥವಾ ಸ್ವತಂತ್ರವಾಗಿ ಪರಿಶೀಲಿಸಿಲ್ಲ.'), review: review('needs-review') },
    ...
    { id: 'src-numista-hoysala-empire', type: 'numismatic-catalogue', title: name('Items from the Empire of Hoysala — Numista', 'ಹೊಯ್ಸಳ ಸಾಮ್ರಾಜ್ಯದ ವಸ್ತುಗಳು — ನುಮಿಸ್ಟಾ'), authors: ['Numista contributors'], year: null, url: 'https://en.numista.com/catalogue/hoysala_empire-1.html', scope: name('Community-maintained numismatic catalogue giving denomination, metal, weight and diameter for Hoysala coin types (fanam, kasu, tara). Dynasty/type-level reference only; not matched to a specific findspot or specimen photograph, and not a substitute for a specialist print catalogue (e.g. Mitchiner).', 'ಹೊಯ್ಸಳ ನಾಣ್ಯ ಬಗೆಗಳಿಗೆ (ಫಣಂ, ಕಾಸು, ತಾರಾ) ಮೌಲ್ಯ, ಲೋಹ, ತೂಕ ಮತ್ತು ವ್ಯಾಸ ನೀಡುವ ಸಮುದಾಯ-ನಿರ್ವಹಿತ ನಾಣ್ಯಶಾಸ್ತ್ರ ಪಟ್ಟಿ. ವಂಶ/ಬಗೆ-ಮಟ್ಟದ ಆಕರ ಮಾತ್ರ; ನಿರ್ದಿಷ್ಟ ಪತ್ತೆಸ್ಥಳ ಅಥವಾ ಛಾಯಾಚಿತ್ರಿತ ಮಾದರಿಗೆ ಹೊಂದಿಸಿಲ್ಲ, ಮತ್ತು ವಿಶೇಷಜ್ಞ ಮುದ್ರಿತ ಪಟ್ಟಿಗೆ (ಉದಾ. ಮಿಚಿನರ್) ಪರ್ಯಾಯವಲ್ಲ.'), review: review('needs-review') },
    ...
    { id: 'src-coinindia-tipu-sultan-patan-mint', type: 'numismatic-catalogue', title: name('The COININDIA Coin Galleries: Mysore, Tipu Sultan', 'ದಿ ಕಾಯಿನ್‌ಇಂಡಿಯಾ ನಾಣ್ಯ ಗ್ಯಾಲರಿಗಳು: ಮೈಸೂರು, ಟಿಪ್ಪು ಸುಲ್ತಾನ್'), authors: ['Sanjeev Kumar (CoinIndia)'], year: null, url: 'https://coinindia.com/galleries-tipusultan.html', scope: name('Specialist numismatic reference giving weight, diameter, legend description and Krause-Mishler (KM) catalogue numbers for photographed Tipu Sultan specimens, including Patan (Srirangapatna) mint gold pagodas and copper paisa denominations. Independent review still required before a specimen is promoted.', 'ಟಿಪ್ಪು ಸುಲ್ತಾನ್ ಮಾದರಿಗಳ ತೂಕ, ವ್ಯಾಸ, ಲೇಖ ವಿವರಣೆ ಮತ್ತು ಕ್ರಾಸ್-ಮಿಶ್ಲರ್ (KM) ಪಟ್ಟಿ ಸಂಖ್ಯೆಗಳನ್ನು ನೀಡುವ ವಿಶೇಷಜ್ಞ ನಾಣ್ಯಶಾಸ್ತ್ರ ಆಕರ, ಪಟಣ (ಶ್ರೀರಂಗಪಟ್ಟಣ) ಟಂಕಶಾಲೆಯ ಚಿನ್ನದ ಪಗೋಡ ಮತ್ತು ತಾಮ್ರದ ಪೈಸ ಮೌಲ್ಯಗಳು ಸೇರಿ. ಮಾದರಿಯನ್ನು ಉತ್ತೇಜಿಸುವ ಮೊದಲು ಸ್ವತಂತ್ರ ಪರಿಶೀಲನೆ ಇನ್ನೂ ಅಗತ್ಯ.'), review: review('needs-review') },
    { id: 'src-henderson-1921-coins-haidar-tipu', type: 'numismatic-catalogue', title: name('The Coins of Haidar Ali and Tipu Sultan', 'ಹೈದರ್ ಅಲಿ ಮತ್ತು ಟಿಪ್ಪು ಸುಲ್ತಾನನ ನಾಣ್ಯಗಳು'), authors: ['J.R. Henderson'], year: 1921, url: 'https://archive.org/details/damh.coinsofhaiderali0000jrhe', scope: name('Full scholarly catalogue of Haidar Ali and Tipu Sultan coinage with plates, weights, obverse/reverse legend descriptions and mint attributions across gold, silver and copper denominations; digitised with OCR full text by the Servants of Knowledge/Karnataka Archaeology collection on the Internet Archive. A pre-KM-era catalogue; cross-check catalogue numbers against modern references before promotion.', 'ಹೈದರ್ ಅಲಿ ಮತ್ತು ಟಿಪ್ಪು ಸುಲ್ತಾನ್ ನಾಣ್ಯಗಳ ಸಂಪೂರ್ಣ ವಿದ್ವತ್ ಪಟ್ಟಿ, ಫಲಕಗಳು, ತೂಕ, ಮುಂಭಾಗ/ಹಿಂಭಾಗ ಲೇಖ ವಿವರಣೆ ಮತ್ತು ಚಿನ್ನ, ಬೆಳ್ಳಿ, ತಾಮ್ರ ಮೌಲ್ಯಗಳ ಟಂಕಶಾಲೆ ಗುರುತಿಸುವಿಕೆ ಸಹಿತ; ಸರ್ವೆಂಟ್ಸ್ ಆಫ್ ನಾಲೆಡ್ಜ್/ಕರ್ನಾಟಕ ಆರ್ಕಿಯಾಲಜಿ ಸಂಗ್ರಹದ ಮೂಲಕ ಇಂಟರ್ನೆಟ್ ಆರ್ಕೈವ್‌ನಲ್ಲಿ OCR ಪೂರ್ಣಪಠ್ಯದೊಂದಿಗೆ ಡಿಜಿಟಲೀಕರಿಸಲಾಗಿದೆ. KM-ಪೂರ್ವಯುಗದ ಪಟ್ಟಿ; ಉತ್ತೇಜನಕ್ಕೂ ಮೊದಲು ಪಟ್ಟಿ ಸಂಖ್ಯೆಗಳನ್ನು ಆಧುನಿಕ ಆಕರಗಳೊಂದಿಗೆ ಪುನಃ ಪರಿಶೀಲಿಸಿ.'), review: review('reviewed') },
    ...
    { id: 'src-wikipedia-narasimha-i', type: 'discovery-lead', title: name('Wikipedia: Narasimha I (Hoysala)', 'ವಿಕಿಪೀಡಿಯ: ನರಸಿಂಹ I (ಹೊಯ್ಸಳ)'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Narasimha_I', scope: name('Documents Narasimha I as son and successor of Vishnuvardhana (c. 1152) and father/predecessor of Veera Ballala II (1173), citing the Yalladahalli record of c. 1145. A discovery lead; verify against the inscription and specialist Hoysala chronology before promotion.', 'ನರಸಿಂಹ Iನನ್ನು ವಿಷ್ಣುವರ್ಧನನ ಮಗ ಮತ್ತು ಉತ್ತರಾಧಿಕಾರಿ (ಸು. 1152) ಮತ್ತು ವೀರ ಬಲ್ಲಾಳ IIನ ತಂದೆ/ಪೂರ್ವಾಧಿಕಾರಿ (1173) ಎಂದು ದಾಖಲಿಸುತ್ತದೆ, ಸು. 1145ರ ಯಲ್ಲದಹಳ್ಳಿ ದಾಖಲೆಯನ್ನು ಉಲ್ಲೇಖಿಸುತ್ತದೆ. ಒಂದು ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಶಾಸನ ಮತ್ತು ವಿಶೇಷಜ್ಞ ಹೊಯ್ಸಳ ಕಾಲಕ್ರಮದ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-kanthirava-narasaraja-ii', type: 'discovery-lead', title: name('Wikipedia: Kanthirava Narasaraja II', 'ವಿಕಿಪೀಡಿಯ: ಕಂಠೀರವ ನರಸರಾಜ II'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Kanthirava_Narasaraja_II', scope: name('Documents the 15th Maharaja of Mysore (r. 30 Nov 1704 - March 1714) as son and successor of Chikka Devaraja and father/predecessor of Dodda Krishnaraja I. Discovery lead; verify against palace/inscriptional records before promotion.', '15ನೇ ಮೈಸೂರು ಮಹಾರಾಜ (ಆ. 1704 ನವೆಂಬರ್ 30 - 1714 ಮಾರ್ಚ್) ಚಿಕ್ಕ ದೇವರಾಜನ ಮಗ ಮತ್ತು ಉತ್ತರಾಧಿಕಾರಿ ಹಾಗೂ ದೊಡ್ಡ ಕೃಷ್ಣರಾಜ Iರ ತಂದೆ/ಪೂರ್ವಾಧಿಕಾರಿ ಎಂದು ದಾಖಲಿಸುತ್ತದೆ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಅರಮನೆ/ಶಾಸನ ದಾಖಲೆಗಳ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-dodda-krishnaraja-i', type: 'discovery-lead', title: name('Wikipedia: Dodda Krishnaraja I', 'ವಿಕಿಪೀಡಿಯ: ದೊಡ್ಡ ಕೃಷ್ಣರಾಜ I'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Dodda_Krishnaraja_I', scope: name('Documents Dodda Krishnaraja I (r. 1714-1732) as first-born son of Kanthirava Narasaraja II, and records that direct-line descent ended with him, with Chamaraja Wodeyar VII succeeding as an adopted heir. Discovery lead; verify before promotion.', 'ದೊಡ್ಡ ಕೃಷ್ಣರಾಜ I (ಆ. 1714-1732) ಕಂಠೀರವ ನರಸರಾಜ IIನ ಪ್ರಥಮ ಪುತ್ರನೆಂದೂ, ಅವನೊಂದಿಗೆ ನೇರವಂಶ ಕೊನೆಗೊಂಡಿತೆಂದೂ, ಚಾಮರಾಜ ಒಡೆಯರ್ VII ದತ್ತು ಉತ್ತರಾಧಿಕಾರಿಯಾಗಿ ಬಂದನೆಂದೂ ದಾಖಲಿಸುತ್ತದೆ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-krishnaraja-wadiyar-ii', type: 'discovery-lead', title: name('Wikipedia: Krishnaraja Wadiyar II', 'ವಿಕಿಪೀಡಿಯ: ಕೃಷ್ಣರಾಜ ಒಡೆಯರ್ II'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Krishnaraja_Wadiyar_II', scope: name('Documents Krishnaraja Wadiyar II (r. 1734-1766) as brother and successor of Chamaraja Wodeyar VII, and father of Nanjaraja Wodeyar. Discovery lead; verify before promotion.', 'ಕೃಷ್ಣರಾಜ ಒಡೆಯರ್ II (ಆ. 1734-1766) ಚಾಮರಾಜ ಒಡೆಯರ್ VIIನ ಸಹೋದರ ಮತ್ತು ಉತ್ತರಾಧಿಕಾರಿ, ಮತ್ತು ನಂಜರಾಜ ಒಡೆಯರ್‌ನ ತಂದೆ ಎಂದು ದಾಖಲಿಸುತ್ತದೆ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-nanjaraja-wodeyar', type: 'discovery-lead', title: name('Wikipedia: Nanjaraja Wodeyar', 'ವಿಕಿಪೀಡಿಯ: ನಂಜರಾಜ ಒಡೆಯರ್'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Nanjaraja_Wodeyar', scope: name('Documents Nanjaraja Wodeyar (r. 1766-1770) as eldest son of Krishnaraja Wadiyar II and elder brother/predecessor of Chamaraja Wodeyar VIII. Discovery lead; verify before promotion.', 'ನಂಜರಾಜ ಒಡೆಯರ್ (ಆ. 1766-1770) ಕೃಷ್ಣರಾಜ ಒಡೆಯರ್ IIನ ಹಿರಿಯ ಪುತ್ರ ಮತ್ತು ಚಾಮರಾಜ ಒಡೆಯರ್ VIIIನ ಹಿರಿಯ ಸಹೋದರ/ಪೂರ್ವಾಧಿಕಾರಿ ಎಂದು ದಾಖಲಿಸುತ್ತದೆ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-chamaraja-wodeyar-ix', type: 'discovery-lead', title: name('Wikipedia: Chamaraja Wodeyar IX', 'ವಿಕಿಪೀಡಿಯ: ಚಾಮರಾಜ ಒಡೆಯರ್ IX'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Chamaraja_Wodeyar_IX', scope: name('Documents Chamaraja Wodeyar IX (r. 1776-1796) as younger brother of Chamaraja Wodeyar VIII, adopted into direct succession by Maharani Lakshmi Ammani Devi, and father of Krishnaraja Wadiyar III. Discovery lead; verify before promotion.', 'ಚಾಮರಾಜ ಒಡೆಯರ್ IX (ಆ. 1776-1796) ಚಾಮರಾಜ ಒಡೆಯರ್ VIIIನ ಕಿರಿಯ ಸಹೋದರ, ಮಹಾರಾಣಿ ಲಕ್ಷ್ಮಿ ಅಮ್ಮಣಿ ದೇವಿಯಿಂದ ದತ್ತು ಪಡೆದ ನೇರ ಉತ್ತರಾಧಿಕಾರಿ, ಮತ್ತು ಕೃಷ್ಣರಾಜ ಒಡೆಯರ್ IIIನ ತಂದೆ ಎಂದು ದಾಖಲಿಸುತ್ತದೆ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    ...
    { id: 'src-shastriya-kannada-vishnuvardhana', type: 'research-portal', title: name('Classical Kannada portal: Vishnuvardhana', 'ಶಾಸ್ತ್ರೀಯ ಕನ್ನಡ ಪೋರ್ಟಲ್: ವಿಷ್ಣುವರ್ಧನ'), authors: ['Classical Kannada / Shastriya Kannada project contributors'], year: null, url: 'https://shastriyakannada.org/database/english/land%20history%20and%20people/VISHNUVARDHANA.htm', scope: name('Discovery and synthesis source on Vishnuvardhana\'s campaigns, including the Belur Chennakeshava temple inscription of 1117 recording victory over the Cholas at Talakad; item-level inscription review still required.', 'ವಿಷ್ಣುವರ್ಧನನ ದಂಡಯಾತ್ರೆಗಳ ಬಗ್ಗೆ ಅನ್ವೇಷಣಾ ಮತ್ತು ಸಂಕ್ಷೇಪ ಆಕರ, ತಾಳಗಾಡಿನಲ್ಲಿ ಚೋಳರ ಮೇಲಿನ ಜಯವನ್ನು ದಾಖಲಿಸುವ 1117ರ ಬೇಲೂರು ಚೆನ್ನಕೇಶವ ದೇವಾಲಯ ಶಾಸನ ಸೇರಿ; ವಸ್ತುಮಟ್ಟದ ಶಾಸನ ಪರಿಶೀಲನೆ ಇನ್ನೂ ಅಗತ್ಯ.'), review: review('needs-review') },
    { id: 'src-wikipedia-veera-ballala-ii', type: 'discovery-lead', title: name('Wikipedia: Veera Ballala II', 'ವಿಕಿಪೀಡಿಯ: ವೀರ ಬಲ್ಲಾಳ II'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Veera_Ballala_II', scope: name('Documents Ballala II\'s campaigns against the Yadavas of Devagiri, Southern Kalachuris, Pandyas of Madurai and the Western Chalukyas, and his move to full independence (sources vary between 1187 and 1193). Discovery lead; verify against inscriptions before promotion.', 'ಬಲ್ಲಾಳ IIನ ದೇವಗಿರಿ ಯಾದವರು, ದಕ್ಷಿಣ ಕಳಚೂರಿಗಳು, ಮಧುರೈ ಪಾಂಡ್ಯರು ಮತ್ತು ಪಶ್ಚಿಮ ಚಾಲುಕ್ಯರ ವಿರುದ್ಧದ ದಂಡಯಾತ್ರೆಗಳನ್ನು ಮತ್ತು ಪೂರ್ಣ ಸ್ವಾತಂತ್ರ್ಯದ ಕಡೆಗಿನ ಹೆಜ್ಜೆಯನ್ನು (ಆಕರಗಳು 1187 ಮತ್ತು 1193ರ ನಡುವೆ ಭಿನ್ನ) ದಾಖಲಿಸುತ್ತದೆ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಶಾಸನಗಳ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-hoysala-kingdom-map', type: 'geospatial-discovery-lead', title: name('Wikipedia: Hoysala Kingdom (territorial map)', 'ವಿಕಿಪೀಡಿಯ: ಹೊಯ್ಸಳ ರಾಜ್ಯ (ವ್ಯಾಪ್ತಿ ನಕ್ಷೆ)'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Hoysala_Kingdom', scope: name('Hosts a composite map titled "Greatest extent of the Hoysala kingdom, c. 1050-1355". It is a whole-dynasty composite, not a reign-specific boundary, so it is a comparison lead only until checked against a specialist historical atlas for a specific reign year.', 'ಸು. 1050-1355ರ ಹೊಯ್ಸಳ ರಾಜ್ಯದ ಗರಿಷ್ಠ ವ್ಯಾಪ್ತಿಯ ಸಂಯೋಜಿತ ನಕ್ಷೆಯನ್ನು ಹೊಂದಿದೆ. ಇದು ಇಡೀ ವಂಶದ ಸಂಯೋಜಿತ ನಕ್ಷೆ, ಒಂದು ಆಳ್ವಿಕೆಗೆ ನಿರ್ದಿಷ್ಟವಲ್ಲ; ನಿರ್ದಿಷ್ಟ ಆಳ್ವಿಕೆ-ವರ್ಷಕ್ಕಾಗಿ ವಿಶೇಷಜ್ಞ ಐತಿಹಾಸಿಕ ಭೂಪಟದ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸುವವರೆಗೆ ಇದು ಹೋಲಿಕೆ ಸುಳಿವು ಮಾತ್ರ.'), review: review('needs-review') },
    { id: 'src-wikipedia-treaty-of-mangalore', type: 'discovery-lead', title: name('Wikipedia: Treaty of Mangalore', 'ವಿಕಿಪೀಡಿಯ: ಮಂಗಳೂರು ಒಪ್ಪಂದ'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Treaty_of_Mangalore', scope: name('Documents the 11 March 1784 treaty ending the Second Anglo-Mysore War, under which Tipu Sultan and the British East India Company restored all captured territories, forts and places to each other (status quo ante bellum). Discovery lead; verify against the treaty text before promotion.', '11 ಮಾರ್ಚ್ 1784ರ ಎರಡನೇ ಆಂಗ್ಲ-ಮೈಸೂರು ಯುದ್ಧವನ್ನು ಕೊನೆಗೊಳಿಸಿದ ಒಪ್ಪಂದವನ್ನು ದಾಖಲಿಸುತ್ತದೆ; ಟಿಪ್ಪು ಸುಲ್ತಾನ್ ಮತ್ತು ಬ್ರಿಟಿಷ್ ಈಸ್ಟ್ ಇಂಡಿಯಾ ಕಂಪನಿ ವಶಪಡಿಸಿಕೊಂಡ ಎಲ್ಲಾ ಪ್ರದೇಶ, ಕೋಟೆ ಮತ್ತು ಸ್ಥಳಗಳನ್ನು ಪರಸ್ಪರ ಮರುಸ್ಥಾಪಿಸಿದರು (ಯುದ್ಧಪೂರ್ವ ಸ್ಥಿತಿ). ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಒಪ್ಪಂದ ಪಠ್ಯದ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-maratha-mysore-wars', type: 'discovery-lead', title: name('Wikipedia: Maratha-Mysore Wars', 'ವಿಕಿಪೀಡಿಯ: ಮರಾಠ-ಮೈಸೂರು ಯುದ್ಧಗಳು'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Maratha%E2%80%93Mysore_Wars', scope: name('Documents the Treaty of Gajendragad (April 1787), which ended the Maratha-Mysore War: Tipu Sultan ceded Badami and returned Adoni, Kittur and Nargund, fixing the Tungabhadra river as the wartime frontier between Maratha and Mysore territory. Discovery lead; verify against the treaty text before promotion.', '1787ರ ಏಪ್ರಿಲ್‌ನ ಗಜೇಂದ್ರಗಡ ಒಪ್ಪಂದವನ್ನು ದಾಖಲಿಸುತ್ತದೆ, ಇದು ಮರಾಠ-ಮೈಸೂರು ಯುದ್ಧವನ್ನು ಕೊನೆಗೊಳಿಸಿತು: ಟಿಪ್ಪು ಸುಲ್ತಾನ್ ಬಾದಾಮಿಯನ್ನು ಬಿಟ್ಟುಕೊಟ್ಟು ಅಡೋನಿ, ಕಿತ್ತೂರು ಮತ್ತು ನರಗುಂದವನ್ನು ಹಿಂದಿರುಗಿಸಿದನು, ತುಂಗಭದ್ರಾ ನದಿಯನ್ನು ಮರಾಠ ಮತ್ತು ಮೈಸೂರು ಪ್ರದೇಶಗಳ ನಡುವಿನ ಯುದ್ಧಕಾಲದ ಗಡಿಯನ್ನಾಗಿ ನಿಗದಿಪಡಿಸಿತು. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಒಪ್ಪಂದ ಪಠ್ಯದ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-archive-sii-vol18', type: 'digitized-primary-edition', title: name('South Indian Inscriptions, Volume XVIII (Internet Archive)', 'ದಕ್ಷಿಣ ಭಾರತೀಯ ಶಾಸನಗಳು, ಸಂಪುಟ XVIII (ಇಂಟರ್ನೆಟ್ ಆರ್ಕೈವ್)'), authors: ['Archaeological Survey of India'], year: null, url: 'https://archive.org/details/in.ernet.dli.2015.108231', scope: name('Full digitized text of S.I.I. Vol. XVIII (numbered items 1-462). No. 112 is an undated Vikramaditya VI-period record naming the Jatachola-lineage family of Jomma, his son Dasa (m. Chaudabbarasi) and Dasa\'s children Attiraja and Chanda. OCR discovery source; a reviewer must still check the printed plate/page image.', 'S.I.I. ಸಂಪುಟ XVIIIರ ಸಂಪೂರ್ಣ ಡಿಜಿಟಲೀಕೃತ ಪಠ್ಯ (ಸಂಖ್ಯೆ 1-462). ಸಂಖ್ಯೆ 112 ವಿಕ್ರಮಾದಿತ್ಯ VI ಕಾಲದ ದಿನಾಂಕರಹಿತ ದಾಖಲೆಯಾಗಿದ್ದು, ಜೊಮ್ಮ, ಅವನ ಮಗ ದಾಸ (ಚೌಡಬ್ಬರಸಿಯ ಪತಿ) ಮತ್ತು ದಾಸನ ಮಕ್ಕಳಾದ ಅತ್ತಿರಾಜ ಮತ್ತು ಚಂದ ಎಂಬ ಜಾತಚೋಳ-ವಂಶದ ಕುಟುಂಬವನ್ನು ಹೆಸರಿಸುತ್ತದೆ. OCR ಅನ್ವೇಷಣಾ ಆಕರ; ಪರಿಶೀಲಕರು ಮುದ್ರಿತ ಫಲಕ/ಪುಟ ಚಿತ್ರವನ್ನು ಇನ್ನೂ ಪರಿಶೀಲಿಸಬೇಕು.'), review: review('needs-review') },
    { id: 'src-archive-epigraphia-carnatica-vol2', type: 'digitized-primary-edition', title: name('Epigraphia Carnatica, Volume II: Sravana-Belgola (Internet Archive)', 'ಎಪಿಗ್ರಾಫಿಯಾ ಕರ್ನಾಟಿಕಾ, ಸಂಪುಟ II: ಶ್ರವಣಬೆಳಗೊಳ (ಇಂಟರ್ನೆಟ್ ಆರ್ಕೈವ್)'), authors: ['B. Lewis Rice'], year: 1889, url: 'https://archive.org/details/in.ernet.dli.2015.126235', scope: name('Full digitized text of Epigraphia Carnatica Vol. II, entirely devoted to Shravanabelagola inscriptions. Identifies Nos. 175, 176 and 179 as the trilingual (Kannada, Tamil, Marathi) inscriptions on the Gommateshwara colossus recording Chavundaraya\'s commissioning of the statue, c. 981-983 CE; No. 70 (alt. 64) as Ganga-Raja\'s 1138 basti for his mother Pochawa; and No. 254 (alt. 105) as the 1398 epitaph of the Jain teacher Panditarya. OCR discovery source; a reviewer must still check the printed plate/page image for each item.', 'ಎಪಿಗ್ರಾಫಿಯಾ ಕರ್ನಾಟಿಕಾ ಸಂಪುಟ IIರ ಸಂಪೂರ್ಣ ಡಿಜಿಟಲೀಕೃತ ಪಠ್ಯ, ಸಂಪೂರ್ಣವಾಗಿ ಶ್ರವಣಬೆಳಗೊಳ ಶಾಸನಗಳಿಗೆ ಮೀಸಲಾಗಿದೆ. ಸಂಖ್ಯೆ 175, 176 ಮತ್ತು 179ನ್ನು ಗೊಮ್ಮಟೇಶ್ವರ ಮೂರ್ತಿಯ ಮೇಲಿನ ತ್ರಿಭಾಷಾ (ಕನ್ನಡ, ತಮಿಳು, ಮರಾಠಿ) ಶಾಸನಗಳಾಗಿ ಗುರುತಿಸುತ್ತದೆ, ಚಾವುಂಡರಾಯನ ಮೂರ್ತಿ ನಿರ್ಮಾಣವನ್ನು ದಾಖಲಿಸುತ್ತದೆ, ಸು. 981-983; ಸಂಖ್ಯೆ 70 (ಪರ್ಯಾಯ 64) ಗಂಗರಾಜನ 1138ರ ತಾಯಿ ಪೊಚವ್ವಗಾಗಿನ ಬಸದಿ; ಮತ್ತು ಸಂಖ್ಯೆ 254 (ಪರ್ಯಾಯ 105) ಜೈನ ಗುರು ಪಂಡಿತಾರ್ಯರ 1398ರ ಸಮಾಧಿ ಶಾಸನ. OCR ಅನ್ವೇಷಣಾ ಆಕರ; ಪರಿಶೀಲಕರು ಪ್ರತಿ ವಸ್ತುವಿನ ಮುದ್ರಿತ ಫಲಕ/ಪುಟ ಚಿತ್ರವನ್ನು ಇನ್ನೂ ಪರಿಶೀಲಿಸಬೇಕು.'), review: review('needs-review') },
    { id: 'src-archive-epigraphia-carnatica-vol5-hassan', type: 'digitized-primary-edition', title: name('Epigraphia Carnatica, Volume V Part 1: Hassan District (Internet Archive)', 'ಎಪಿಗ್ರಾಫಿಯಾ ಕರ್ನಾಟಿಕಾ, ಸಂಪುಟ V ಭಾಗ 1: ಹಾಸನ ಜಿಲ್ಲೆ (ಇಂಟರ್ನೆಟ್ ಆರ್ಕೈವ್)'), authors: ['B. Lewis Rice'], year: null, url: 'https://archive.org/details/dli.ernet.213550', scope: name('Full digitized text of Epigraphia Carnatica Vol. V Part 1 (Hassan district). Identifies Belur item Bl. 68 as recording Vishnuvardhana\'s 1117 consecration of the Vijayanarayana/Chennakeshava temple at Velapura (Belur), his military conquests and queen Santala Devi. OCR discovery source; a reviewer must still check the printed plate/page image.', 'ಎಪಿಗ್ರಾಫಿಯಾ ಕರ್ನಾಟಿಕಾ ಸಂಪುಟ V ಭಾಗ 1ರ (ಹಾಸನ ಜಿಲ್ಲೆ) ಸಂಪೂರ್ಣ ಡಿಜಿಟಲೀಕೃತ ಪಠ್ಯ. ಬೇಲೂರು ವಸ್ತು Bl. 68 ಅನ್ನು ವಿಷ್ಣುವರ್ಧನನ 1117ರ ವೇಲಾಪುರ (ಬೇಲೂರು)ದ ವಿಜಯನಾರಾಯಣ/ಚೆನ್ನಕೇಶವ ದೇವಾಲಯ ಪ್ರತಿಷ್ಠಾಪನೆ, ಅವನ ಸೇನಾ ವಿಜಯಗಳು ಮತ್ತು ರಾಣಿ ಶಾಂತಲಾ ದೇವಿಯನ್ನು ದಾಖಲಿಸುವಂತೆ ಗುರುತಿಸುತ್ತದೆ. OCR ಅನ್ವೇಷಣಾ ಆಕರ; ಪರಿಶೀಲಕರು ಮುದ್ರಿತ ಫಲಕ/ಪುಟ ಚಿತ್ರವನ್ನು ಇನ್ನೂ ಪರಿಶೀಲಿಸಬೇಕು.'), review: review('needs-review') },
    { id: 'src-wikipedia-kumara-vyasa', type: 'discovery-lead', title: name('Wikipedia: Kumara Vyasa', 'ವಿಕಿಪೀಡಿಯ: ಕುಮಾರ ವ್ಯಾಸ'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Kumara_Vyasa', scope: name('Biographical discovery lead: pen name of Gadugina Veera Naranappa, court poet under Deva Raya II of Vijayanagara, lived in Koliwad near Gadag, author of Karnata Bharata Kathamanjari (completed 1430) in Bhamini Shatpadi metre. Verify against a specialist literary-history source before promotion.', 'ಜೀವನಚರಿತ್ರೆಯ ಅನ್ವೇಷಣಾ ಸುಳಿವು: ಗದುಗಿನ ವೀರನಾರಣಪ್ಪನ ಕಾವ್ಯನಾಮ, ವಿಜಯನಗರದ ದೇವರಾಯ IIನ ಆಸ್ಥಾನ ಕವಿ, ಗದಗ ಬಳಿಯ ಕೋಳಿವಾಡದಲ್ಲಿ ವಾಸ, ಭಾಮಿನಿ ಷಟ್ಪದಿಯಲ್ಲಿ ಕರ್ಣಾಟ ಭಾರತ ಕಥಾಮಂಜರಿಯ (1430ರಲ್ಲಿ ಪೂರ್ಣ) ಕರ್ತೃ. ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ವಿಶೇಷಜ್ಞ ಸಾಹಿತ್ಯ ಇತಿಹಾಸ ಆಕರದ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-shastriyakannada-toraveya-ramayana', type: 'research-portal', title: name('Classical Kannada portal: Toraveya Ramayana', 'ಶಾಸ್ತ್ರೀಯ ಕನ್ನಡ ಪೋರ್ಟಲ್: ತೊರವೆಯ ರಾಮಾಯಣ'), authors: ['Classical Kannada / Shastriya Kannada project contributors'], year: null, url: 'https://shastriyakannada.org/database/english/literature/TORAVEYA%20RAMAYANA%20HTML.htm', scope: name('Discovery and synthesis source on Kumara Valmiki (pen name of Narahari), who composed the Toraveya Ramayana from c. 1500 at the Narasimha temple, Torvi (Torave); item-level edition review still required.', 'ಕುಮಾರ ವಾಲ್ಮೀಕಿ (ನರಹರಿಯ ಕಾವ್ಯನಾಮ) ಕುರಿತ ಅನ್ವೇಷಣಾ ಮತ್ತು ಸಂಕ್ಷೇಪ ಆಕರ, ಇವರು ಸು. 1500ರಿಂದ ತೊರವಿ (ತೊರವೆ)ಯ ನರಸಿಂಹ ದೇವಾಲಯದಲ್ಲಿ ತೊರವೆಯ ರಾಮಾಯಣವನ್ನು ರಚಿಸಿದರು; ವಸ್ತುಮಟ್ಟದ ಆವೃತ್ತಿ ಪರಿಶೀಲನೆ ಇನ್ನೂ ಅಗತ್ಯ.'), review: review('needs-review') },
    { id: 'src-archive-kumaravyasa-karnata-bharata-kathamanjari', type: 'digitized-print-edition', title: name('Kumaravyasa Mahakaviya Karnata Bharata Kathamanjari, ed. Kuvempu & Masti Venkatesha Iyengar (Internet Archive)', 'ಕುಮಾರವ್ಯಾಸ ಮಹಾಕಾವ್ಯ ಕರ್ಣಾಟ ಭಾರತ ಕಥಾಮಂಜರಿ, ಸಂ. ಕುವೆಂಪು ಮತ್ತು ಮಾಸ್ತಿ ವೆಂಕಟೇಶ ಅಯ್ಯಂಗಾರ್ (ಇಂಟರ್ನೆಟ್ ಆರ್ಕೈವ್)'), authors: ['Kumaravyasa', 'Kuvempu (ed.)', 'Masti Venkatesha Iyengar (ed.)'], year: null, url: 'https://archive.org/details/gss.kumaravyasamahak0000kuve', licence:'freely downloadable on Internet Archive; formal copyright status of this Government of Mysore-era edition not independently confirmed', scope: name('676-page government-published critical edition of Kumaravyasa Bharata (Karnata Bharata Kathamanjari), edited by Kuvempu and Masti Venkatesha Iyengar, published by the Mysore State Department of Literature and Culture. Freely downloadable in full (PDF/EPUB); usable as an edition-comparison witness pending independent scholarly review.', '676-ಪುಟಗಳ ಸರ್ಕಾರಿ-ಪ್ರಕಟಿತ ಕುಮಾರವ್ಯಾಸ ಭಾರತ (ಕರ್ಣಾಟ ಭಾರತ ಕಥಾಮಂಜರಿ) ವಿಮರ್ಶಾತ್ಮಕ ಆವೃತ್ತಿ, ಕುವೆಂಪು ಮತ್ತು ಮಾಸ್ತಿ ವೆಂಕಟೇಶ ಅಯ್ಯಂಗಾರ್ ಸಂಪಾದಿಸಿದ್ದು, ಮೈಸೂರು ಸಂಸ್ಥಾನದ ಸಾಹಿತ್ಯ ಮತ್ತು ಸಂಸ್ಕೃತಿ ಇಲಾಖೆಯಿಂದ ಪ್ರಕಟಿತ. ಸಂಪೂರ್ಣವಾಗಿ ಉಚಿತ ಡೌನ್‌ಲೋಡ್ (PDF/EPUB); ಸ್ವತಂತ್ರ ವಿದ್ವತ್ ಪರಿಶೀಲನೆಯವರೆಗೆ ಆವೃತ್ತಿ-ಹೋಲಿಕೆ ಸಾಕ್ಷ್ಯವಾಗಿ ಬಳಸಬಹುದು.'), review: review('needs-review') },
    { id: 'src-murty-classical-library-kannada-mahabharata', type: 'scholarly-translation', title: name('The Kannada Mahabharata, Vol. 1 (Murty Classical Library of India, Harvard University Press)', 'ದಿ ಕನ್ನಡ ಮಹಾಭಾರತ, ಸಂಪುಟ 1 (ಮೂರ್ತಿ ಕ್ಲಾಸಿಕಲ್ ಲೈಬ್ರರಿ ಆಫ್ ಇಂಡಿಯಾ, ಹಾರ್ವರ್ಡ್ ಯೂನಿವರ್ಸಿಟಿ ಪ್ರೆಸ್)'), authors: ['Kumaravyasa', 'S. N. Sridhar (tr.)', 'C. N. Ramachandran (tr.)', 'Narayan Hegde (tr.)'], year: null, url: 'https://www.hup.harvard.edu/file/feeds/PDF/9780674292543_sample.pdf', licence:'Harvard University Press, commercial publication; not open access', scope: name('Modern scholarly bilingual (Kannada/English) critical edition and translation of Kumaravyasa Bharata, part of the Murty Classical Library of India series. A strong edition-comparison witness against the Kuvempu/Masti government edition; not itself an open digital witness.', 'ಕುಮಾರವ್ಯಾಸ ಭಾರತದ ಆಧುನಿಕ ವಿದ್ವತ್ ದ್ವಿಭಾಷಾ (ಕನ್ನಡ/ಇಂಗ್ಲಿಷ್) ವಿಮರ್ಶಾತ್ಮಕ ಆವೃತ್ತಿ ಮತ್ತು ಅನುವಾದ, ಮೂರ್ತಿ ಕ್ಲಾಸಿಕಲ್ ಲೈಬ್ರರಿ ಆಫ್ ಇಂಡಿಯಾ ಸರಣಿಯ ಭಾಗ. ಕುವೆಂಪು/ಮಾಸ್ತಿ ಸರ್ಕಾರಿ ಆವೃತ್ತಿಯ ವಿರುದ್ಧ ಬಲಿಷ್ಠ ಆವೃತ್ತಿ-ಹೋಲಿಕೆ ಸಾಕ್ಷ್ಯ; ಇದು ಸ್ವತಃ ಮುಕ್ತ ಡಿಜಿಟಲ್ ಸಾಕ್ಷ್ಯವಲ್ಲ.'), review: review('needs-review') },
    { id: 'src-archive-epigraphia-carnatica-vol7-shimoga', type: 'digitized-primary-edition', title: name('Epigraphia Carnatica, Volume VII: Shimoga District (Internet Archive)', 'ಎಪಿಗ್ರಾಫಿಯಾ ಕರ್ನಾಟಿಕಾ, ಸಂಪುಟ VII: ಶಿವಮೊಗ್ಗ ಜಿಲ್ಲೆ (ಇಂಟರ್ನೆಟ್ ಆರ್ಕೈವ್)'), authors: ['B. Lewis Rice'], year: null, url: 'https://archive.org/details/epigraphia_carnatica_vol7_myso', scope: name('Full digitized text of Epigraphia Carnatica Vol. VII (Shimoga district). Identifies the Talagunda pillar inscription as Shikaripur-taluk item Sk. 176: a 46-line granite pillar beside the Pranaveshvara temple, giving the Kadamba dynastic genealogy up to King Shantivarman, dated c. 455-470 CE; also edited by Kielhorn in Epigraphia Indica. OCR discovery source; a reviewer must still check the printed plate/page image.', 'ಎಪಿಗ್ರಾಫಿಯಾ ಕರ್ನಾಟಿಕಾ ಸಂಪುಟ VIIರ (ಶಿವಮೊಗ್ಗ ಜಿಲ್ಲೆ) ಸಂಪೂರ್ಣ ಡಿಜಿಟಲೀಕೃತ ಪಠ್ಯ. ತಾಳಗುಂದ ಸ್ತಂಭ ಶಾಸನವನ್ನು ಶಿಕಾರಿಪುರ-ತಾಲೂಕು ವಸ್ತು Sk. 176 ಎಂದು ಗುರುತಿಸುತ್ತದೆ: ಪ್ರಾಣವೇಶ್ವರ ದೇವಾಲಯದ ಬಳಿಯ 46-ಸಾಲಿನ ಗ್ರಾನೈಟ್ ಸ್ತಂಭ, ರಾಜ ಶಾಂತಿವರ್ಮನವರೆಗಿನ ಕದಂಬ ವಂಶಾವಳಿಯನ್ನು ನೀಡುತ್ತದೆ, ಸು. 455-470; ಕೀಲ್‌ಹಾರ್ನ್ ಎಪಿಗ್ರಾಫಿಯಾ ಇಂಡಿಕಾದಲ್ಲೂ ಸಂಪಾದಿಸಿದ್ದಾರೆ. OCR ಅನ್ವೇಷಣಾ ಆಕರ; ಪರಿಶೀಲಕರು ಮುದ್ರಿತ ಫಲಕ/ಪುಟ ಚಿತ್ರವನ್ನು ಇನ್ನೂ ಪರಿಶೀಲಿಸಬೇಕು.'), review: review('needs-review') },
    { id: 'src-wikipedia-harihareshwara-temple', type: 'discovery-lead', title: name('Wikipedia: Harihareshwara Temple, Harihar', 'ವಿಕಿಪೀಡಿಯ: ಹರಿಹರೇಶ್ವರ ದೇವಾಲಯ, ಹರಿಹರ'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Harihareshwara_Temple', scope: name('Documents the Harihareshwara temple at Harihar (Davanagere district), built c. 1223-1224 CE by Polalva, a commander/minister of the Hoysala king Vira Narasimha II, with 1268 CE additions by Soma, a commander of Narasimha III; a smaller 5th-century temple preceded it. Discovery lead; verify against Epigraphia Carnatica and ASI protection records before promotion.', 'ಹರಿಹರ (ದಾವಣಗೆರೆ ಜಿಲ್ಲೆ) ಹರಿಹರೇಶ್ವರ ದೇವಾಲಯವನ್ನು ದಾಖಲಿಸುತ್ತದೆ, ಹೊಯ್ಸಳ ಅರಸ ವೀರ ನರಸಿಂಹ IIನ ಸೇನಾಪತಿ/ಮಂತ್ರಿ ಪೊಲಾಳ್ವನಿಂದ ಸು. 1223-1224ರಲ್ಲಿ ಕಟ್ಟಲ್ಪಟ್ಟಿತು, 1268ರಲ್ಲಿ ನರಸಿಂಹ IIIನ ಸೇನಾಪತಿ ಸೋಮನಿಂದ ಸೇರ್ಪಡೆಗಳು; ಇದಕ್ಕೂ ಮೊದಲು 5ನೇ ಶತಮಾನದ ಸಣ್ಣ ದೇವಾಲಯವಿತ್ತು. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಎಪಿಗ್ರಾಫಿಯಾ ಕರ್ನಾಟಿಕಾ ಮತ್ತು ASI ಸಂರಕ್ಷಣಾ ದಾಖಲೆಗಳ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-western-ganga-administration', type: 'discovery-lead', title: name('Wikipedia: Western Ganga administration', 'ವಿಕಿಪೀಡಿಯ: ಪಶ್ಚಿಮ ಗಂಗ ಆಡಳಿತ'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Western_Ganga_administration', scope: name('Documents the Western Ganga administrative hierarchy: Rashtra (district) subdivided into Visaya/Nadu (province, roughly 1000 villages) and Desa; from 725 CE the core territory was known as Gangavadi-96000 (Shannavati Sahasra Vishaya, "96 Nadus"), covering roughly modern Mysuru, Mandya and Chamarajanagar districts. Discovery lead; verify against inscriptional administrative records before promotion.', 'ಪಶ್ಚಿಮ ಗಂಗ ಆಡಳಿತ ಶ್ರೇಣಿಯನ್ನು ದಾಖಲಿಸುತ್ತದೆ: ರಾಷ್ಟ್ರ (ಜಿಲ್ಲೆ) ವಿಷಯ/ನಾಡು (ಪ್ರಾಂತ, ಸು. 1000 ಗ್ರಾಮಗಳು) ಮತ್ತು ದೇಶವಾಗಿ ಉಪವಿಭಜಿತ; 725ರಿಂದ ಮೂಲ ಪ್ರದೇಶವನ್ನು ಗಂಗವಾಡಿ-96000 (ಷಣ್ಣವತಿ ಸಹಸ್ರ ವಿಷಯ, "96 ನಾಡುಗಳು") ಎಂದು ಕರೆಯಲಾಗುತ್ತಿತ್ತು, ಇಂದಿನ ಮೈಸೂರು, ಮಂಡ್ಯ ಮತ್ತು ಚಾಮರಾಜನಗರ ಜಿಲ್ಲೆಗಳನ್ನು ಸುಮಾರಾಗಿ ಒಳಗೊಂಡಿತ್ತು. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಶಾಸನ ಆಡಳಿತ ದಾಖಲೆಗಳ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-begur-inscriptions', type: 'discovery-lead', title: name('Wikipedia: Begur inscriptions and hero stones', 'ವಿಕಿಪೀಡಿಯ: ಬೇಗೂರು ಶಾಸನಗಳು ಮತ್ತು ವೀರಗಲ್ಲುಗಳು'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Begur_inscriptions_and_hero_stones', scope: name('Cites Epigraphia Carnatica Vol. IX Supplement, Bangalore inscription no. 174 (c. 900 CE) as the earliest known written reference to "Bengaluru" (bengulura kalage, the Bengaluru battle), commemorating the deaths of Pervvonashetti and Buttanapati, sons of the chieftain Nagattara. The stone is housed at the Panchalingeshwara/Nageshvara temple complex, Begur. Discovery lead; verify against the printed EC volume before promotion.', 'ಎಪಿಗ್ರಾಫಿಯಾ ಕರ್ನಾಟಿಕಾ ಸಂಪುಟ IX ಪೂರಕ, ಬೆಂಗಳೂರು ಶಾಸನ ಸಂಖ್ಯೆ 174 (ಸು. ಕ್ರಿ.ಶ. 900) ಅನ್ನು "ಬೆಂಗಳೂರು"ಗೆ (ಬೆಂಗುಳೂರ ಕಳಗೆ, ಬೆಂಗಳೂರು ಕಾಳಗ) ಮೊದಲ ಲಿಖಿತ ಉಲ್ಲೇಖವಾಗಿ ಉಲ್ಲೇಖಿಸುತ್ತದೆ, ಮುಖಂಡ ನಾಗತ್ತರನ ಪುತ್ರರಾದ ಪೆರ್ವೊನಶೆಟ್ಟಿ ಮತ್ತು ಬುತ್ತನಪತಿಯ ಸಾವನ್ನು ಸ್ಮರಿಸುತ್ತದೆ. ಶಿಲೆ ಬೇಗೂರಿನ ಪಂಚಲಿಂಗೇಶ್ವರ/ನಾಗೇಶ್ವರ ದೇವಾಲಯ ಸಂಕೀರ್ಣದಲ್ಲಿದೆ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಮುದ್ರಿತ EC ಸಂಪುಟದ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-battle-of-talikota', type: 'discovery-lead', title: name('Wikipedia: Battle of Talikota', 'ವಿಕಿಪೀಡಿಯ: ತಾಳಿಕೋಟೆ ಯುದ್ಧ'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Battle_of_Talikota', scope: name('Documents the 23 January 1565 battle: a coalition of the Bijapur, Golconda, Ahmadnagar and Bidar sultanates defeated Vijayanagara\'s field army; Rama Raya was beheaded by (or on the order of) Husain Nizam Shah I of Ahmadnagar; the capital city was sacked over five months and never reoccupied. Discovery lead; verify against court chronicles and specialist Deccan histories before promotion.', '23 ಜನವರಿ 1565ರ ಯುದ್ಧವನ್ನು ದಾಖಲಿಸುತ್ತದೆ: ಬಿಜಾಪುರ, ಗೋಲ್ಕೊಂಡ, ಅಹಮದ್ ನಗರ ಮತ್ತು ಬೀದರ್ ಸುಲ್ತಾನರ ಒಕ್ಕೂಟ ವಿಜಯನಗರದ ಸೇನೆಯನ್ನು ಸೋಲಿಸಿತು; ರಾಮರಾಯನನ್ನು ಅಹಮದ್‌ನಗರದ ಹುಸೇನ್ ನಿಜಾಮ್ ಶಾ I ಶಿರಚ್ಛೇದ ಮಾಡಿದನು (ಅಥವಾ ಅವನ ಆದೇಶದ ಮೇಲೆ); ರಾಜಧಾನಿಯನ್ನು ಐದು ತಿಂಗಳ ಕಾಲ ಲೂಟಿ ಮಾಡಲಾಯಿತು ಮತ್ತು ಮತ್ತೆಂದೂ ಪುನರ್ ವಸತಿಯಾಗಲಿಲ್ಲ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಆಸ್ಥಾನ ವೃತ್ತಾಂತ ಮತ್ತು ವಿಶೇಷಜ್ಞ ದಖ್ಖನ್ ಇತಿಹಾಸಗಳ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-siddhesvara-temple-haveri', type: 'discovery-lead', title: name('Wikipedia: Siddhesvara Temple, Haveri', 'ವಿಕಿಪೀಡಿಯ: ಸಿದ್ಧೇಶ್ವರ ದೇವಾಲಯ, ಹಾವೇರಿ'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Siddhesvara_Temple', scope: name('Documents the soapstone Siddhesvara Temple at Haveri, an example of Western Chalukyan art with 11th-century core construction and 12th-century additions; an Old Kannada grant inscription on an interior beam is dated 1087 CE and a stone inscription outside is dated 1108 CE. Discovery lead; verify against Epigraphia Carnatica/Indica and ASI protection records before promotion.', 'ಹಾವೇರಿಯ ಸಿದ್ಧೇಶ್ವರ ದೇವಾಲಯ, ಪಶ್ಚಿಮ ಚಾಲುಕ್ಯ ಶೈಲಿಯ ಶಿಲ್ಪಕಲೆಯ ಉದಾಹರಣೆ, 11ನೇ ಶತಮಾನದ ಮೂಲ ನಿರ್ಮಾಣ ಮತ್ತು 12ನೇ ಶತಮಾನದ ಸೇರ್ಪಡೆಗಳೊಂದಿಗೆ; ಒಳಗಿನ ತೊಲೆಯ ಮೇಲಿನ ಹಳೆಗನ್ನಡ ದಾನ ಶಾಸನ 1087ರ ದಿನಾಂಕ, ಹೊರಗಿನ ಶಿಲಾಶಾಸನ 1108ರ ದಿನಾಂಕ ಹೊಂದಿದೆ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಎಪಿಗ್ರಾಫಿಯಾ ಕರ್ನಾಟಿಕಾ/ಇಂಡಿಕಾ ಮತ್ತು ASI ಸಂರಕ್ಷಣಾ ದಾಖಲೆಗಳ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-punch-marked-coins', type: 'discovery-lead', title: name('Wikipedia: Punch-marked coins', 'ವಿಕಿಪೀಡಿಯ: ಪಂಚಮುದ್ರಿತ ನಾಣ್ಯಗಳು'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Punch-marked_coins', scope: name('Documents the general Mauryan-period silver karshapana type: struck (not cast), typically 3.4-3.6 g at .750-.850 fine silver, with five standard punches. Dynasty/type-level discovery lead only; no Maski-specific hoard or specimen data. Verify against a specialist numismatic catalogue and the Maski excavation/hoard report before promotion.', 'ಮೌರ್ಯ ಕಾಲದ ಸಾಮಾನ್ಯ ಬೆಳ್ಳಿ ಕಾರ್ಷಾಪಣ ಬಗೆಯನ್ನು ದಾಖಲಿಸುತ್ತದೆ: ಟಂಕಿತ (ಎರಕವಲ್ಲ), ಸಾಮಾನ್ಯವಾಗಿ 3.4-3.6 ಗ್ರಾಂ, .750-.850 ಶುದ್ಧ ಬೆಳ್ಳಿ, ಐದು ಪ್ರಮಾಣಿತ ಮುದ್ರೆಗಳೊಂದಿಗೆ. ವಂಶ/ಬಗೆ-ಮಟ್ಟದ ಅನ್ವೇಷಣಾ ಸುಳಿವು ಮಾತ್ರ; ಮಸ್ಕಿ-ನಿರ್ದಿಷ್ಟ ನಿಧಿ ಅಥವಾ ಮಾದರಿ ದತ್ತಾಂಶವಿಲ್ಲ. ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ವಿಶೇಷಜ್ಞ ನಾಣ್ಯಶಾಸ್ತ್ರ ಪಟ್ಟಿ ಮತ್ತು ಮಸ್ಕಿ ಉತ್ಖನನ/ನಿಧಿ ವರದಿಯ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-kaidala-chennakeshava', type: 'discovery-lead', title: name('Kaidala Chennakeshava Temple discovery lead', 'ಕೈದಾಳ ಚೆನ್ನಕೇಶವ ದೇವಾಲಯ ಅನ್ವೇಷಣಾ ಸುಳಿವು'), authors: ['Web discovery aggregation'], year: null, url: 'https://www.tripoto.com/tumkur/trips/chenna-keshava-temple-kaidala-tumkur-947359', scope: name('Documents the Chennakeshava temple at Kaidala village (Tumkur district), built 1150-1151 CE by the local chief Samanta/Gule Bachi, a subordinate of the Hoysala king Narasimha I; two Hale Kannada stone inscriptions at the adjacent Gangadhareshwara temple record the foundation, along with a Narayana temple. Discovery lead aggregated from multiple secondary web sources; verify against Epigraphia Carnatica (Tumkur district) and the inscription text itself before promotion.', 'ಕೈದಾಳ ಗ್ರಾಮದ (ತುಮಕೂರು ಜಿಲ್ಲೆ) ಚೆನ್ನಕೇಶವ ದೇವಾಲಯವನ್ನು ದಾಖಲಿಸುತ್ತದೆ, 1150-1151ರಲ್ಲಿ ಸ್ಥಳೀಯ ಮುಖಂಡ ಸಾಮಂತ/ಗುಳೆ ಬಚ್ಚಿ, ಹೊಯ್ಸಳ ಅರಸ ನರಸಿಂಹ Iನ ಅಧೀನ, ಕಟ್ಟಿಸಿದ್ದು; ಪಕ್ಕದ ಗಂಗಾಧರೇಶ್ವರ ದೇವಾಲಯದಲ್ಲಿನ ಎರಡು ಹಳೆಗನ್ನಡ ಶಿಲಾಶಾಸನಗಳು ಈ ಸ್ಥಾಪನೆಯನ್ನು, ನಾರಾಯಣ ದೇವಾಲಯದೊಂದಿಗೆ, ದಾಖಲಿಸುತ್ತವೆ. ಹಲವಾರು ದ್ವಿತೀಯ ಜಾಲ ಆಕರಗಳಿಂದ ಸಂಗ್ರಹಿಸಿದ ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಎಪಿಗ್ರಾಫಿಯಾ ಕರ್ನಾಟಿಕಾ (ತುಮಕೂರು ಜಿಲ್ಲೆ) ಮತ್ತು ಶಾಸನ ಪಠ್ಯದ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-battle-of-raichur', type: 'discovery-lead', title: name('Wikipedia: Battle of Raichur', 'ವಿಕಿಪೀಡಿಯ: ರಾಯಚೂರು ಯುದ್ಧ'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Battle_of_Raichur', scope: name('Documents the 19 May 1520 Battle of Raichur: Krishnadevaraya, commanded in the field by his chief minister Saluva Timmarusu and assisted by Portuguese gunners under Christovao de Figueiredo, defeated Ismail Adil Shah of Bijapur (Adil Shahi), who abandoned further conquest plans afterward. Discovery lead; verify against Portuguese/court chronicle sources before promotion.', '19 ಮೇ 1520ರ ರಾಯಚೂರು ಯುದ್ಧವನ್ನು ದಾಖಲಿಸುತ್ತದೆ: ಕೃಷ್ಣದೇವರಾಯ, ಅವನ ಮುಖ್ಯಮಂತ್ರಿ ಸಾಳುವ ತಿಮ್ಮರಸುವಿನ ನೇತೃತ್ವದಲ್ಲಿ ಮತ್ತು ಕ್ರಿಸ್ಟೊವಾವ್ ಡಿ ಫಿಗುಯೆರೆಡೊ ನೇತೃತ್ವದ ಪೋರ್ಚುಗೀಸ್ ಫಿರಂಗಿದಾರರ ಸಹಾಯದಿಂದ, ಬಿಜಾಪುರದ (ಆದಿಲ್ ಶಾಹಿ) ಇಸ್ಮಾಯಿಲ್ ಆದಿಲ್ ಶಾನನ್ನು ಸೋಲಿಸಿದನು, ಅವನು ನಂತರ ಮತ್ತಷ್ಟು ವಿಜಯದ ಯೋಜನೆಗಳನ್ನು ಕೈಬಿಟ್ಟನು. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಪೋರ್ಚುಗೀಸ್/ಆಸ್ಥಾನ ವೃತ್ತಾಂತ ಆಕರಗಳ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-archive-ajitapurana-sannayya-ramagauda', type: 'digitized-print-edition', title: name('Ajita Tirthakara Puranam of Ranna, ed. N. Sannayya Rama Gauda (Internet Archive)', 'ರನ್ನನ ಅಜಿತ ತೀರ್ಥಕರ ಪುರಾಣಂ, ಸಂ. ಎನ್. ಸಣ್ಣಯ್ಯ ರಾಮಗೌಡ (ಇಂಟರ್ನೆಟ್ ಆರ್ಕೈವ್)'), authors: ['Ranna', 'N. Sannayya Rama Gauda (ed.)'], year: null, url: 'https://archive.org/details/ajita-tirthakara-puranam-of-ranna-by-n-sannayya-rama-gauda-jangamwadi-math-collection', licence:'freely downloadable on Internet Archive; formal copyright status not independently confirmed', scope: name('Jangamwadi Math Library Collection digitized edition of Ranna\'s Ajitapurana (993 CE), the shortest Jain purana in Kannada, narrating the life of the second tirthankara Ajitanatha. Freely downloadable in full; usable as an edition-comparison witness pending independent scholarly review.', 'ರನ್ನನ ಅಜಿತಪುರಾಣದ (993) ಜಂಗಮವಾಡಿ ಮಠ ಗ್ರಂಥಾಲಯ ಸಂಗ್ರಹದ ಡಿಜಿಟಲೀಕೃತ ಆವೃತ್ತಿ, ಕನ್ನಡದ ಅತ್ಯಂತ ಚಿಕ್ಕ ಜೈನ ಪುರಾಣ, ಎರಡನೇ ತೀರ್ಥಂಕರ ಅಜಿತನಾಥನ ಜೀವನವನ್ನು ನಿರೂಪಿಸುತ್ತದೆ. ಸಂಪೂರ್ಣವಾಗಿ ಉಚಿತ ಡೌನ್‌ಲೋಡ್; ಸ್ವತಂತ್ರ ವಿದ್ವತ್ ಪರಿಶೀಲನೆಯವರೆಗೆ ಆವೃತ್ತಿ-ಹೋಲಿಕೆ ಸಾಕ್ಷ್ಯವಾಗಿ ಬಳಸಬಹುದು.'), review: review('needs-review') },
    { id: 'src-archive-shantipurana-vidyashankar', type: 'digitized-print-edition', title: name('Ponna Shanti Purana Sangraha, ed. Dr. S. Vidyashankar (Internet Archive)', 'ಪೊನ್ನ ಶಾಂತಿಪುರಾಣ ಸಂಗ್ರಹ, ಸಂ. ಡಾ. ಎಸ್. ವಿದ್ಯಾಶಂಕರ್ (ಇಂಟರ್ನೆಟ್ ಆರ್ಕೈವ್)'), authors: ['Ponna', 'S. Vidyashankar (ed.)'], year: null, url: 'https://archive.org/details/ibQB_ponna-shanti-purana-sangraha-by-dr.-s.-vidyashankar-kannada-priyadarshini-prakashan', licence:'CC0 1.0 Universal (public domain dedication)', scope: name('Priyadarshini Prakashan edition of Ponna\'s Shantipurana, a twelve-chapter champu biography of the sixteenth tirthankara Shantinatha, digitized by the Jangamwadi Math Library Collection at 600 DPI with Kannada OCR. Explicitly released CC0; freely downloadable in full; usable as an edition-comparison witness pending independent scholarly review.', 'ಪೊನ್ನನ ಶಾಂತಿಪುರಾಣದ ಪ್ರಿಯದರ್ಶಿನಿ ಪ್ರಕಾಶನ ಆವೃತ್ತಿ, ಹದಿನಾರನೇ ತೀರ್ಥಂಕರ ಶಾಂತಿನಾಥನ ಹನ್ನೆರಡು-ಅಧ್ಯಾಯದ ಚಂಪೂ ಜೀವನಚರಿತ್ರೆ, ಜಂಗಮವಾಡಿ ಮಠ ಗ್ರಂಥಾಲಯ ಸಂಗ್ರಹದಿಂದ 600 DPIನಲ್ಲಿ ಕನ್ನಡ OCR ಜೊತೆ ಡಿಜಿಟಲೀಕೃತ. ಸ್ಪಷ್ಟವಾಗಿ CC0 ಬಿಡುಗಡೆ; ಸಂಪೂರ್ಣವಾಗಿ ಉಚಿತ ಡೌನ್‌ಲೋಡ್; ಸ್ವತಂತ್ರ ವಿದ್ವತ್ ಪರಿಶೀಲನೆಯವರೆಗೆ ಆವೃತ್ತಿ-ಹೋಲಿಕೆ ಸಾಕ್ಷ್ಯವಾಗಿ ಬಳಸಬಹುದು.'), review: review('needs-review') },
    { id: 'src-wikipedia-kolar-karnataka', type: 'discovery-lead', title: name('Wikipedia: Kolar, Karnataka', 'ವಿಕಿಪೀಡಿಯ: ಕೋಲಾರ, ಕರ್ನಾಟಕ'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Kolar,_Karnataka', scope: name('Documents Kolar\'s ancient names (Kuvalala, Kolala, Kolahalapura) and its founding as the Western Ganga capital by Konganivarman Madhava c. 350 CE, with later Ganga rulers holding the title Kuvalala-puravareshvara; also documents c. 4000 years of gold-mining archaeology at the Kolar Gold Fields (Chigaragunta radiocarbon evidence, c. 2600 years BP). Discovery lead; verify against inscriptions and archaeological reports before promotion.', 'ಕೋಲಾರದ ಪ್ರಾಚೀನ ಹೆಸರುಗಳನ್ನು (ಕುವಲಾಲ, ಕೋಲಾಲ, ಕೋಲಾಹಲಪುರ) ಮತ್ತು ಕೊಂಗಣಿವರ್ಮ ಮಾಧವನಿಂದ ಸು. ಕ್ರಿ.ಶ. 350ರಲ್ಲಿ ಪಶ್ಚಿಮ ಗಂಗ ರಾಜಧಾನಿಯಾಗಿ ಸ್ಥಾಪನೆಯನ್ನು ದಾಖಲಿಸುತ್ತದೆ, ನಂತರದ ಗಂಗ ಅರಸರು ಕುವಲಾಲ-ಪುರವರೇಶ್ವರ ಬಿರುದು ಹೊಂದಿದ್ದರು; ಕೋಲಾರ ಚಿನ್ನದ ಗಣಿಗಳಲ್ಲಿ ಸು. 4000 ವರ್ಷಗಳ ಚಿನ್ನ-ಗಣಿಗಾರಿಕೆ ಪುರಾತತ್ತ್ವವನ್ನೂ (ಚಿಗರಗುಂಟ ರೇಡಿಯೊಕಾರ್ಬನ್ ಸಾಕ್ಷ್ಯ, ಸು. 2600 ವರ್ಷ BP) ದಾಖಲಿಸುತ್ತದೆ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಶಾಸನ ಮತ್ತು ಪುರಾತತ್ತ್ವ ವರದಿಗಳ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-archive-kavirajamarga-sundaram', type: 'digitized-print-edition', title: name('Kavirajamarga, verse-by-verse translation by R.V.S. Sundaram (Internet Archive)', 'ಕವಿರಾಜಮಾರ್ಗ, ಆರ್.ವಿ.ಎಸ್. ಸುಂದರಂ ಸಾಲುವಾರು ಅನುವಾದ (ಇಂಟರ್ನೆಟ್ ಆರ್ಕೈವ್)'), authors: ['Srivijaya (attributed)', 'R. V. S. Sundaram (tr.)'], year: null, url: 'https://archive.org/details/KavirajamargamR.V.S.Sundaram', licence:'freely downloadable on Internet Archive; formal copyright status not independently confirmed', scope: name('Verse-by-verse translation into English and modern Kannada of Kavirajamarga (c. 850 CE), the earliest surviving Kannada treatise on poetics, traditionally associated with Rashtrakuta king Amoghavarsha I and court poet Srivijaya. Freely downloadable in full; usable as an edition-comparison witness pending independent scholarly review.', 'ಕವಿರಾಜಮಾರ್ಗದ (ಸು. ಕ್ರಿ.ಶ. 850) ಇಂಗ್ಲಿಷ್ ಮತ್ತು ಆಧುನಿಕ ಕನ್ನಡಕ್ಕೆ ಸಾಲುವಾರು ಅನುವಾದ, ಇದು ಉಳಿದಿರುವ ಅತ್ಯಂತ ಹಳೆಯ ಕನ್ನಡ ಕಾವ್ಯಶಾಸ್ತ್ರ ಗ್ರಂಥ, ಸಾಂಪ್ರದಾಯಿಕವಾಗಿ ರಾಷ್ಟ್ರಕೂಟ ಅಮೋಘವರ್ಷ I ಮತ್ತು ಆಸ್ಥಾನ ಕವಿ ಶ್ರೀವಿಜಯರೊಂದಿಗೆ ಸಂಬಂಧಿಸಿದೆ. ಸಂಪೂರ್ಣವಾಗಿ ಉಚಿತ ಡೌನ್‌ಲೋಡ್; ಸ್ವತಂತ್ರ ವಿದ್ವತ್ ಪರಿಶೀಲನೆಯವರೆಗೆ ಆವೃತ್ತಿ-ಹೋಲಿಕೆ ಸಾಕ್ಷ್ಯವಾಗಿ ಬಳಸಬಹುದು.'), review: review('needs-review') },
    { id: 'src-archive-vikramarjuna-vijaya-kuvempu', type: 'digitized-print-edition', title: name('Pampa Bharatam emba Vikramarjuna Vijayam, ed. K. V. Puttappa/Kuvempu (Internet Archive)', 'ಪಂಪ ಭಾರತಂ ಎಂಬ ವಿಕ್ರಮಾರ್ಜುನ ವಿಜಯಂ, ಸಂ. ಕೆ.ವಿ. ಪುಟ್ಟಪ್ಪ/ಕುವೆಂಪು (ಇಂಟರ್ನೆಟ್ ಆರ್ಕೈವ್)'), authors: ['Pampa', 'K. V. Puttappa / Kuvempu (ed.)'], year: 1969, url: 'https://archive.org/details/bmshri.pampabharatamemb0000kvpu', licence:'freely downloadable on Internet Archive; formal copyright status not independently confirmed', scope: name('492-page Mysore University edition (1969) of Pampa\'s Vikramarjuna Vijaya (Pampa Bharata, c. 941 CE), edited by Kuvempu; scanned by Servants of Knowledge in partnership with the Internet Archive. Freely downloadable in full; usable as an edition-comparison witness pending independent scholarly review.', 'ಮೈಸೂರು ವಿಶ್ವವಿದ್ಯಾಲಯದ 1969ರ 492-ಪುಟಗಳ ಪಂಪನ ವಿಕ್ರಮಾರ್ಜುನ ವಿಜಯ (ಪಂಪ ಭಾರತ, ಸು. ಕ್ರಿ.ಶ. 941) ಆವೃತ್ತಿ, ಕುವೆಂಪು ಸಂಪಾದಿಸಿದ್ದು; ಸರ್ವೆಂಟ್ಸ್ ಆಫ್ ನಾಲೆಡ್ಜ್ ಇಂಟರ್ನೆಟ್ ಆರ್ಕೈವ್ ಜೊತೆಗೂಡಿ ಸ್ಕ್ಯಾನ್ ಮಾಡಿದ್ದಾರೆ. ಸಂಪೂರ್ಣವಾಗಿ ಉಚಿತ ಡೌನ್‌ಲೋಡ್; ಸ್ವತಂತ್ರ ವಿದ್ವತ್ ಪರಿಶೀಲನೆಯವರೆಗೆ ಆವೃತ್ತಿ-ಹೋಲಿಕೆ ಸಾಕ್ಷ್ಯವಾಗಿ ಬಳಸಬಹುದು.'), review: review('needs-review') },
    { id: 'src-wikipedia-kappe-arabhatta', type: 'discovery-lead', title: name('Wikipedia: Kappe Arabhatta', 'ವಿಕಿಪೀಡಿಯ: ಕಪ್ಪೆ ಅರಭಟ್ಟ'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Kappe_Arabhatta', scope: name('Documents the c. 700 CE Kappe Arabhatta verse inscription cut into a cliff near Tattukoti hamlet at the north-east corner of the Badami lake: five stanzas in ten lines (one Sanskrit shloka, the rest in the earliest recorded Kannada tripadi metre), catalogued as Indian Antiquary Vol. X, item 61 (the "Tattukoti Inscription"), and discussed in A. N. Narasimhia\'s 1941 "A Grammar of the Oldest Kanarese Inscriptions". Discovery lead; verify against the printed edition before promotion.', 'ಬಾದಾಮಿ ಸರೋವರದ ಈಶಾನ್ಯ ಮೂಲೆಯ ತಟ್ಟುಕೋಟಿ ಹಳ್ಳಿಯ ಬಳಿಯ ಬಂಡೆಯ ಮೇಲೆ ಕೊರೆದ ಸು. ಕ್ರಿ.ಶ. 700ರ ಕಪ್ಪೆ ಅರಭಟ್ಟ ಪದ್ಯ ಶಾಸನವನ್ನು ದಾಖಲಿಸುತ್ತದೆ: ಹತ್ತು ಸಾಲುಗಳಲ್ಲಿ ಐದು ಪದ್ಯಗಳು (ಒಂದು ಸಂಸ್ಕೃತ ಶ್ಲೋಕ, ಉಳಿದವು ಮೊದಲ ದಾಖಲಿತ ಕನ್ನಡ ತ್ರಿಪದಿ ಛಂದಸ್ಸಿನಲ್ಲಿ), ಇಂಡಿಯನ್ ಆಂಟಿಕ್ವರಿ ಸಂಪುಟ X, ವಸ್ತು 61 ("ತಟ್ಟುಕೋಟಿ ಶಾಸನ") ಎಂದು ಪಟ್ಟಿಮಾಡಲಾಗಿದೆ, ಮತ್ತು ಎ. ಎನ್. ನರಸಿಂಹಯ್ಯನವರ 1941ರ "A Grammar of the Oldest Kanarese Inscriptions"ನಲ್ಲಿ ಚರ್ಚಿಸಲಾಗಿದೆ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಮುದ್ರಿತ ಆವೃತ್ತಿಯ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-narasimhia-grammar-oldest-kanarese-inscriptions', type: 'book', title: name('A Grammar of the Oldest Kanarese Inscriptions', 'A Grammar of the Oldest Kanarese Inscriptions'), authors: ['A. N. Narasimhia'], year: 1941, url: '', scope: name('University of Mysore monograph on the grammar of the earliest Kannada inscriptions, including Kappe Arabhatta; not yet independently checked against this atlas\'s inscription record.', 'ಆರಂಭಿಕ ಕನ್ನಡ ಶಾಸನಗಳ ವ್ಯಾಕರಣದ ಮೈಸೂರು ವಿಶ್ವವಿದ್ಯಾಲಯ ಗ್ರಂಥ, ಕಪ್ಪೆ ಅರಭಟ್ಟ ಸೇರಿ; ಈ ಭೂಪಟದ ಶಾಸನ ದಾಖಲೆಯೊಂದಿಗೆ ಇನ್ನೂ ಸ್ವತಂತ್ರವಾಗಿ ಪರಿಶೀಲಿಸಿಲ್ಲ.'), review: review('needs-review') },
    { id: 'src-wikipedia-krishnadevaraya-administration', type: 'discovery-lead', title: name('Wikipedia: Krishnadevaraya (administration)', 'ವಿಕಿಪೀಡಿಯ: ಕೃಷ್ಣದೇವರಾಯ (ಆಡಳಿತ)'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Krishnadevaraya', scope: name('Documents the Vijayanagara provincial administrative hierarchy under Krishnadevaraya: Rajya (province) - Kottam/Sime (region/county) - Kampana/Sthala (municipality), with amaranayakas holding amaram land grants for revenue and troops. Discovery lead; verify against inscriptional administrative records before promotion.', 'ಕೃಷ್ಣದೇವರಾಯನ ಕಾಲದ ವಿಜಯನಗರ ಪ್ರಾಂತೀಯ ಆಡಳಿತ ಶ್ರೇಣಿಯನ್ನು ದಾಖಲಿಸುತ್ತದೆ: ರಾಜ್ಯ (ಪ್ರಾಂತ) - ಕೊಟ್ಟಂ/ಸೀಮೆ (ಪ್ರದೇಶ/ಜಿಲ್ಲೆ) - ಕಂಪಣ/ಸ್ಥಳ (ಪುರಸಭೆ), ಅಮರನಾಯಕರು ಆದಾಯ ಮತ್ತು ಸೈನ್ಯಕ್ಕಾಗಿ ಅಮರಂ ಭೂಮಿ ಅನುದಾನ ಹೊಂದಿದ್ದರು. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಶಾಸನ ಆಡಳಿತ ದಾಖಲೆಗಳ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-sanjan-copper-plate', type: 'discovery-lead', title: name('Wikipedia: Amoghavarsha (Sanjan copper plate)', 'ವಿಕಿಪೀಡಿಯ: ಅಮೋಘವರ್ಷ (ಸಂಜಾನ್ ತಾಮ್ರಪಟ)'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Amoghavarsha', scope: name('Documents the 872 CE Sanjan copper-plate inscription of Amoghavarsha I, authored by his chief justice/army-general Vatsaraja, recording homage from the rulers of Anga, Vanga, Magadha and the Pallavas of Kanchi. Discovery lead; verify against the inscription edition before promotion.', 'ಅಮೋಘವರ್ಷ Iನ 872ರ ಸಂಜಾನ್ ತಾಮ್ರಪಟ ಶಾಸನವನ್ನು ದಾಖಲಿಸುತ್ತದೆ, ಇದನ್ನು ಅವನ ಮುಖ್ಯ ನ್ಯಾಯಾಧೀಶ/ಸೇನಾಪತಿ ವತ್ಸರಾಜ ರಚಿಸಿದನು, ಅಂಗ, ವಂಗ, ಮಗಧ ಮತ್ತು ಕಾಂಚಿಯ ಪಲ್ಲವರ ಅಧೀನತೆಯನ್ನು ದಾಖಲಿಸುತ್ತದೆ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಶಾಸನ ಆವೃತ್ತಿಯ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-aihole-inscription', type: 'discovery-lead', title: name('Wikipedia: Aihole inscription', 'ವಿಕಿಪೀಡಿಯ: ಐಹೊಳೆ ಶಾಸನ'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Aihole_inscription', scope: name('Documents the 634-635 CE Aihole prasasti of Ravikirti, which gives the Badami Chalukya genealogy: Pulakeshin I (grandfather) - Kirttivarman I (father, r. 566-592/597) - Pulakeshin II. Discovery lead; verify against the inscription text itself (already the atlas\'s inscription-aihole record) before promotion.', '634-635ರ ರವಿಕೀರ್ತಿಯ ಐಹೊಳೆ ಪ್ರಶಸ್ತಿಯನ್ನು ದಾಖಲಿಸುತ್ತದೆ, ಇದು ಬಾದಾಮಿ ಚಾಲುಕ್ಯ ವಂಶಾವಳಿಯನ್ನು ನೀಡುತ್ತದೆ: ಪುಲಕೇಶಿ I (ಅಜ್ಜ) - ಕೀರ್ತಿವರ್ಮ I (ತಂದೆ, ಆ. 566-592/597) - ಪುಲಕೇಶಿ II. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಶಾಸನ ಪಠ್ಯದ ವಿರುದ್ಧ (ಈಗಾಗಲೇ ಭೂಪಟದ inscription-aihole ದಾಖಲೆ) ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-kadamba-talagunda-succession', type: 'discovery-lead', title: name('Wikipedia: Kadamba succession (Bhageerath, Raghu, Kakusthavarma)', 'ವಿಕಿಪೀಡಿಯ: ಕದಂಬ ಉತ್ತರಾಧಿಕಾರ (ಭಗೀರಥ, ರಘು, ಕಾಕುಸ್ಥವರ್ಮ)'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Bhageerath', scope: name('Cross-verification discovery lead for the Talagunda pillar-inscription genealogy: Kangavarma succeeded by his son Bhageerath (c. 385-410), then Bhageerath\'s son Raghu (died childless fighting the Pallavas), then Raghu\'s younger brother Kakusthavarma. Verify against the inscription text and specialist Kadamba chronology before promotion.', 'ತಾಳಗುಂದ ಸ್ತಂಭ ಶಾಸನದ ವಂಶಾವಳಿಗೆ ಅಡ್ಡ-ಪರಿಶೀಲನಾ ಅನ್ವೇಷಣಾ ಸುಳಿವು: ಕಂಗವರ್ಮನ ನಂತರ ಅವನ ಮಗ ಭಗೀರಥ (ಸು. 385-410), ನಂತರ ಭಗೀರಥನ ಮಗ ರಘು (ಪಲ್ಲವರ ವಿರುದ್ಧ ಹೋರಾಡುತ್ತಾ ನಿಸ್ಸಂತಾನನಾಗಿ ಮೃತ), ನಂತರ ರಘುವಿನ ಕಿರಿಯ ಸಹೋದರ ಕಾಕುಸ್ಥವರ್ಮ. ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಶಾಸನ ಪಠ್ಯ ಮತ್ತು ವಿಶೇಷಜ್ಞ ಕದಂಬ ಕಾಲಕ್ರಮದ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-numista-rashtrakuta-dynasty', type: 'numismatic-catalogue', title: name('Items from the Rashtrakuta Dynasty — Numista', 'ರಾಷ್ಟ್ರಕೂಟ ವಂಶದ ವಸ್ತುಗಳು — ನುಮಿಸ್ಟಾ'), authors: ['Numista contributors'], year: null, url: 'https://en.numista.com/catalogue/rashtrakuta_dynasty-1.html', scope: name('Community-maintained numismatic catalogue giving denomination, metal, weight and diameter for Rashtrakuta coin types, including an anonymous gold gadyana (3.96 g, 14.45 mm, c. 900-1100) and several silver damma types. Dynasty/type-level reference only; not matched to a specific findspot or specimen photograph.', 'ರಾಷ್ಟ್ರಕೂಟ ನಾಣ್ಯ ಬಗೆಗಳಿಗೆ ಮೌಲ್ಯ, ಲೋಹ, ತೂಕ ಮತ್ತು ವ್ಯಾಸ ನೀಡುವ ಸಮುದಾಯ-ನಿರ್ವಹಿತ ನಾಣ್ಯಶಾಸ್ತ್ರ ಪಟ್ಟಿ, ಅನಾಮಧೇಯ ಚಿನ್ನದ ಗದ್ಯಾಣ (3.96 ಗ್ರಾಂ, 14.45 ಮಿ.ಮೀ, ಸು. 900-1100) ಮತ್ತು ಹಲವಾರು ಬೆಳ್ಳಿಯ ದಮ್ಮ ಬಗೆಗಳು ಸೇರಿ. ವಂಶ/ಬಗೆ-ಮಟ್ಟದ ಆಕರ ಮಾತ್ರ; ನಿರ್ದಿಷ್ಟ ಪತ್ತೆಸ್ಥಳ ಅಥವಾ ಛಾಯಾಚಿತ್ರಿತ ಮಾದರಿಗೆ ಹೊಂದಿಸಿಲ್ಲ.'), review: review('needs-review') },
    { id: 'src-numista-yadava-dynasty', type: 'numismatic-catalogue', title: name('Items from the Yadava Dynasty (Devagiri) — Numista', 'ಯಾದವ ವಂಶದ (ದೇವಗಿರಿ) ವಸ್ತುಗಳು — ನುಮಿಸ್ಟಾ'), authors: ['Numista contributors'], year: null, url: 'https://en.numista.com/catalogue/yadava_dynasty-1.html', scope: name('Community-maintained numismatic catalogue giving denomination, ruler, metal, weight and diameter for Seuna/Yadava of Devagiri coin types (Bhillama V, Singhana II, Krishna, Mahadeva, Ramadeva), mostly gold padmatanka/gadyana coins around 3.8 g. Dynasty/type-level reference only; not matched to a specific findspot or specimen photograph.', 'ಸೇವುಣ/ಯಾದವ ದೇವಗಿರಿ ನಾಣ್ಯ ಬಗೆಗಳಿಗೆ (ಭಿಲ್ಲಮ V, ಸಿಂಘಣ II, ಕೃಷ್ಣ, ಮಹಾದೇವ, ರಾಮದೇವ) ಮೌಲ್ಯ, ಆಳ್ವಿಕೆಗಾರ, ಲೋಹ, ತೂಕ ಮತ್ತು ವ್ಯಾಸ ನೀಡುವ ಸಮುದಾಯ-ನಿರ್ವಹಿತ ನಾಣ್ಯಶಾಸ್ತ್ರ ಪಟ್ಟಿ, ಹೆಚ್ಚಾಗಿ ಸು. 3.8 ಗ್ರಾಂ ಚಿನ್ನದ ಪದ್ಮಟಂಕ/ಗದ್ಯಾಣ ನಾಣ್ಯಗಳು. ವಂಶ/ಬಗೆ-ಮಟ್ಟದ ಆಕರ ಮಾತ್ರ; ನಿರ್ದಿಷ್ಟ ಪತ್ತೆಸ್ಥಳ ಅಥವಾ ಛಾಯಾಚಿತ್ರಿತ ಮಾದರಿಗೆ ಹೊಂದಿಸಿಲ್ಲ.'), review: review('needs-review') },
    { id: 'src-numista-chalukya-dynasty', type: 'numismatic-catalogue', title: name('Items from the Chalukya Dynasty — Numista', 'ಚಾಲುಕ್ಯ ವಂಶದ ವಸ್ತುಗಳು — ನುಮಿಸ್ಟಾ'), authors: ['Numista contributors'], year: null, url: 'https://en.numista.com/catalogue/chalukya_dynasty-1.html', scope: name('Community-maintained numismatic catalogue; lists a Badami Chalukya gold gadyana (3.7 g, c. 700-900) among later Chalukya-branch and feudatory entries. Dynasty/type-level reference only; not matched to a specific findspot or specimen photograph.', 'ಸಮುದಾಯ-ನಿರ್ವಹಿತ ನಾಣ್ಯಶಾಸ್ತ್ರ ಪಟ್ಟಿ; ನಂತರದ ಚಾಲುಕ್ಯ-ಶಾಖೆ ಮತ್ತು ಸಾಮಂತ ದಾಖಲೆಗಳ ನಡುವೆ ಬಾದಾಮಿ ಚಾಲುಕ್ಯ ಚಿನ್ನದ ಗದ್ಯಾಣವನ್ನು (3.7 ಗ್ರಾಂ, ಸು. 700-900) ಪಟ್ಟಿಮಾಡುತ್ತದೆ. ವಂಶ/ಬಗೆ-ಮಟ್ಟದ ಆಕರ ಮಾತ್ರ; ನಿರ್ದಿಷ್ಟ ಪತ್ತೆಸ್ಥಳ ಅಥವಾ ಛಾಯಾಚಿತ್ರಿತ ಮಾದರಿಗೆ ಹೊಂದಿಸಿಲ್ಲ.'), review: review('needs-review') },
    { id: 'src-wikipedia-nagabhata-ii', type: 'discovery-lead', title: name('Wikipedia: Nagabhata II', 'ವಿಕಿಪೀಡಿಯ: ನಾಗಭಟ II'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Nagabhata_II', scope: name('Documents Nagabhata II (r. 800-833 CE) capturing Kannauj from the Pala vassal Chakrayudha, defeating Dharmapala and advancing to Munger, before his own defeat by the Rashtrakuta Govinda III. Discovery lead; verify against inscriptions and specialist chronology before promotion.', 'ನಾಗಭಟ II (ಆ. 800-833) ಪಾಲ ಅಧೀನ ಚಕ್ರಾಯುಧನಿಂದ ಕನ್ನೌಜ್ ವಶಪಡಿಸಿಕೊಂಡು, ಧರ್ಮಪಾಲನನ್ನು ಸೋಲಿಸಿ ಮುಂಗೇರ್‌ವರೆಗೆ ಮುನ್ನಡೆದನೆಂದೂ, ನಂತರ ರಾಷ್ಟ್ರಕೂಟ ಗೋವಿಂದ IIIರಿಂದ ಸೋಲನುಭವಿಸಿದನೆಂದೂ ದಾಖಲಿಸುತ್ತದೆ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಶಾಸನ ಮತ್ತು ವಿಶೇಷಜ್ಞ ಕಾಲಕ್ರಮದ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-wikipedia-tripartite-struggle', type: 'discovery-lead', title: name('Wikipedia: Tripartite Struggle', 'ವಿಕಿಪೀಡಿಯ: ತ್ರಿಪಕ್ಷೀಯ ಸಂಘರ್ಷ'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Tripartite_Struggle', scope: name('Documents the c. 800 CE struggle for control of Kannauj between the Rashtrakutas (Govinda III), Gurjara-Pratiharas (Nagabhata II) and Palas (Dharmapala, his vassal Chakrayudha): Dharmapala installs Chakrayudha, Nagabhata II defeats both and occupies Kannauj, then Govinda III defeats Nagabhata II in the Doab, after which Dharmapala and Chakrayudha submit to Rashtrakuta overlordship. Discovery lead; verify against inscriptions and specialist chronology before promotion.', 'ಸು. ಕ್ರಿ.ಶ. 800ರ ಕನ್ನೌಜ್ ನಿಯಂತ್ರಣಕ್ಕಾಗಿ ರಾಷ್ಟ್ರಕೂಟರು (ಗೋವಿಂದ III), ಗುರ್ಜರ-ಪ್ರತಿಹಾರರು (ನಾಗಭಟ II) ಮತ್ತು ಪಾಲರ (ಧರ್ಮಪಾಲ, ಅಧೀನ ಚಕ್ರಾಯುಧ) ನಡುವಿನ ಸಂಘರ್ಷವನ್ನು ದಾಖಲಿಸುತ್ತದೆ: ಧರ್ಮಪಾಲ ಚಕ್ರಾಯುಧನನ್ನು ಸ್ಥಾಪಿಸುತ್ತಾನೆ, ನಾಗಭಟ II ಇಬ್ಬರನ್ನೂ ಸೋಲಿಸಿ ಕನ್ನೌಜ್ ವಶಪಡಿಸಿಕೊಳ್ಳುತ್ತಾನೆ, ನಂತರ ಗೋವಿಂದ III ದೋಆಬ್‌ನಲ್ಲಿ ನಾಗಭಟ IIನನ್ನು ಸೋಲಿಸುತ್ತಾನೆ, ಇದಾದ ನಂತರ ಧರ್ಮಪಾಲ ಮತ್ತು ಚಕ್ರಾಯುಧ ರಾಷ್ಟ್ರಕೂಟ ಪರಮಾಧಿಕಾರಕ್ಕೆ ಶರಣಾಗುತ್ತಾರೆ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಶಾಸನ ಮತ್ತು ವಿಶೇಷಜ್ಞ ಕಾಲಕ್ರಮದ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-sciencedirect-sanganakallu-kupgal', type: 'journal-article', title: name('Lithic technology and social transformations in the South Indian Neolithic: the evidence from Sanganakallu-Kupgal', 'ದಕ್ಷಿಣ ಭಾರತ ನವಶಿಲಾಯುಗದ ಶಿಲಾ ತಂತ್ರಜ್ಞಾನ ಮತ್ತು ಸಾಮಾಜಿಕ ಪರಿವರ್ತನೆಗಳು: ಸಂಗನಕಲ್ಲು-ಕುಪ್ಗಲ್‌ನ ಸಾಕ್ಷ್ಯ'), authors: ['Journal of Anthropological Archaeology'], year: null, url: 'https://www.sciencedirect.com/science/article/pii/S0278416511000663', scope: name('Peer-reviewed archaeological study of the Sanganakallu-Kupgal Neolithic/Mesolithic complex near Ballari; dates the ashmound/axe-production phase from c. 1900 BCE with peak output 1400-1200 BCE.', 'ಬಳ್ಳಾರಿ ಬಳಿಯ ಸಂಗನಕಲ್ಲು-ಕುಪ್ಗಲ್ ನವಶಿಲಾಯುಗ/ಮಧ್ಯಶಿಲಾಯುಗ ಸಂಕೀರ್ಣದ ಪೀರ್-ಪರಿಶೀಲಿತ ಪುರಾತತ್ತ್ವ ಅಧ್ಯಯನ; ಬೂದಿದಿಬ್ಬ/ಕೊಡಲಿ-ಉತ್ಪಾದನಾ ಹಂತವನ್ನು ಸು. ಕ್ರಿ.ಪೂ. 1900ರಿಂದ, ಗರಿಷ್ಠ ಉತ್ಪಾದನೆ 1400-1200 ಎಂದು ದಿನಾಂಕಿಸುತ್ತದೆ.'), review: review('reviewed') },
    { id: 'src-wikipedia-sanganakallu', type: 'discovery-lead', title: name('Wikipedia: Sanganakallu', 'ವಿಕಿಪೀಡಿಯ: ಸಂಗನಕಲ್ಲು'), authors: ['Wikipedia contributors'], year: null, url: 'https://en.wikipedia.org/wiki/Sanganakallu', scope: name('Site location, extent and excavation history for the Sanganakallu-Kupgal complex. Discovery lead; verify against the archaeological literature and field survey before promotion.', 'ಸಂಗನಕಲ್ಲು-ಕುಪ್ಗಲ್ ಸಂಕೀರ್ಣದ ತಾಣ ಸ್ಥಳ, ವ್ಯಾಪ್ತಿ ಮತ್ತು ಉತ್ಖನನ ಇತಿಹಾಸ. ಅನ್ವೇಷಣಾ ಸುಳಿವು; ಪ್ರಚಾರಕ್ಕೂ ಮೊದಲು ಪುರಾತತ್ತ್ವ ಸಾಹಿತ್ಯ ಮತ್ತು ಕ್ಷೇತ್ರ ಸಮೀಕ್ಷೆಯ ವಿರುದ್ಧ ಪರಿಶೀಲಿಸಿ.'), review: review('needs-review') },
    { id: 'src-archive-torave-ramayana-vol2', type: 'digitized-print-edition', title: name('Torave Ramayana, Volume 2, by Kumara Valmiki (Internet Archive)', 'ತೊರವೆ ರಾಮಾಯಣ, ಸಂಪುಟ 2, ಕುಮಾರ ವಾಲ್ಮೀಕಿ (ಇಂಟರ್ನೆಟ್ ಆರ್ಕೈವ್)'), authors: ['Kumara Valmiki', 'Kannada Sahitya Parishat (publisher)'], year: 1977, url: 'https://archive.org/details/toraveramayanavo0000kuma', licence:'freely downloadable on Internet Archive; formal copyright status of this 1977 Kannada Sahitya Parishat edition not independently confirmed', scope: name('Volume 2 of a Kannada Sahitya Parishat print edition of Torave Ramayana, freely downloadable in full. Volume 1 has not yet been located on the Internet Archive. Usable as an edition-comparison witness pending independent scholarly review.', 'ತೊರವೆ ರಾಮಾಯಣದ ಕನ್ನಡ ಸಾಹಿತ್ಯ ಪರಿಷತ್ತು ಮುದ್ರಿತ ಆವೃತ್ತಿಯ ಸಂಪುಟ 2, ಸಂಪೂರ್ಣವಾಗಿ ಉಚಿತ ಡೌನ್‌ಲೋಡ್. ಸಂಪುಟ 1 ಇನ್ನೂ ಇಂಟರ್ನೆಟ್ ಆರ್ಕೈವ್‌ನಲ್ಲಿ ಪತ್ತೆಯಾಗಿಲ್ಲ. ಸ್ವತಂತ್ರ ವಿದ್ವತ್ ಪರಿಶೀಲನೆಯವರೆಗೆ ಆವೃತ್ತಿ-ಹೋಲಿಕೆ ಸಾಕ್ಷ್ಯವಾಗಿ ಬಳಸಬಹುದು.'), review: review('needs-review') },
  ...
  places: [
    ...
    ['srirangapatna','Srirangapatna','ಶ್ರೀರಂಗಪಟ್ಟಣ',12.42,76.66],['mangaluru','Mangaluru','ಮಂಗಳೂರು',12.91,74.86],['bengaluru','Bengaluru','ಬೆಂಗಳೂರು',12.97,77.59],['penukonda','Penukonda','ಪೆನುಕೊಂಡ',14.08,77.59],['goa','Goa, Portuguese India','ಗೋವಾ, ಪೋರ್ಚುಗೀಸ್ ಭಾರತ',15.49,73.82,'historical-port'],['herat','Herat','ಹೆರಾತ್',34.35,62.20],['cairo','Cairo','ಕೈರೋ',30.04,31.24],['shiraz','Shiraz','ಶಿರಾಜ್',29.59,52.58],['istanbul','Istanbul','ಇಸ್ತಾಂಬುಲ್',41.01,28.98],['gaya','Gaya, Bihar','ಗಯಾ, ಬಿಹಾರ',24.7955,84.9994,'historical-site'],['kantavara','Kantavara (Shettibettu), Dakshina Kannada','ಕಾಂತಾವರ (ಶೆಟ್ಟಿಬೆಟ್ಟು), ದಕ್ಷಿಣ ಕನ್ನಡ',13.05,74.98,'historical-site'],['kugve','Kugve (Talaguppe hobli), Sagara taluk, Shivamogga','ಕುಗ್ವೆ (ತಾಳಗುಪ್ಪ ಹೋಬಳಿ), ಸಾಗರ ತಾಲ್ಲೂಕು, ಶಿವಮೊಗ್ಗ',14.16,74.83,'historical-site'],['sringeri','Sringeri','ಶೃಂಗೇರಿ',13.42,75.25,'religious-site'],['ballari','Ballari (Bellary)','ಬಳ್ಳಾರಿ',15.14,76.92],['versailles','Versailles','ವರ್ಸೈಲ್ಸ್',48.80,2.13],['lobu-tua','Lobu Tua near Barus, Sumatra','ಸುಮಾತ್ರಾದ ಬರೂಸ್ ಸಮೀಪದ ಲೋಬು ತುವಾ',2.02,98.38,'historical-site'],
    ...
    ['hampi-hemakuta','Hemakuta Hill Temple Group','ಹೇಮಕೂಟ ಬೆಟ್ಟದ ದೇವಾಲಯ ಸಮೂಹ',15.3336,76.4602,'monument'],
    ...
    ['anegundi','Anegundi','ಆನೆಗುಂದಿ',15.3389,76.4757],['udupi','Udupi (Barkur region)','ಉಡುಪಿ (ಬಾರಕೂರು ಪ್ರದೇಶ)',13.3409,74.7421],
    ['kummata','Kummatadurga','ಕುಮ್ಮಟದುರ್ಗ',15.4200,76.3700]
  ...
  people: [
    ['mayurasharma','Mayurasharma','ಮಯೂರಶರ್ಮ','polity-kadamba'],['kangavarma','Kangavarma','ಕಂಗವರ್ಮ','polity-kadamba'],['bhagiratha','Bhagiratha','ಭಗೀರಥ','polity-kadamba'],['raghu-kadamba','Raghu','ರಘು','polity-kadamba'],['kakusthavarma','Kakusthavarma','ಕಾಕುಸ್ಥವರ್ಮ','polity-kadamba'],
    ...
    ['vishnuvardhana','Vishnuvardhana','ವಿಷ್ಣುವರ್ಧನ','polity-hoysala'],['narasimha-i','Narasimha I','ನರಸಿಂಹ I','polity-hoysala'],['ballala-ii','Ballala II','ಬಲ್ಲಾಳ II','polity-hoysala'],['narasimha-ii','Vira Narasimha II','ವೀರ ನರಸಿಂಹ II','polity-hoysala'],['narasimha-iii','Narasimha III','ನರಸಿಂಹ III','polity-hoysala'],['ballala-iii','Ballala III','ಬಲ್ಲಾಳ III','polity-hoysala'],
  ...
  works: [
    ...
    ['kumaravyasa-bharata','Kumaravyasa Bharata','ಕುಮಾರವ್ಯಾಸ ಭಾರತ','Kumaravyasa','ಕುಮಾರವ್ಯಾಸ',1430,'polity-vijayanagara','person-kumaravyasa'],['torave-ramayana','Torave Ramayana','ತೊರವೆ ರಾಮಾಯಣ','Kumara Valmiki','ಕುಮಾರ ವಾಲ್ಮೀಕಿ',1500,'polity-vijayanagara','person-kumara-valmiki']
...
const mysoreWadiyarBridgePeople = [
  ['kanthirava-narasaraja-ii','Kanthirava Narasaraja II','ಕಂಠೀರವ ನರಸರಾಜ II',1704,1714,'src-wikipedia-kanthirava-narasaraja-ii'],
  ['dodda-krishnaraja-i','Dodda Krishnaraja I','ದೊಡ್ಡ ಕೃಷ್ಣರಾಜ I',1714,1732,'src-wikipedia-dodda-krishnaraja-i'],
  ['chamaraja-wodeyar-vii','Chamaraja Wodeyar VII','ಚಾಮರಾಜ ಒಡೆಯರ್ VII',1732,1734,'src-wikipedia-krishnaraja-wadiyar-ii'],
  ['krishnaraja-wadiyar-ii','Krishnaraja Wadiyar II','ಕೃಷ್ಣರಾಜ ಒಡೆಯರ್ II',1734,1766,'src-wikipedia-krishnaraja-wadiyar-ii'],
  ['nanjaraja-wodeyar','Nanjaraja Wodeyar','ನಂಜರಾಜ ಒಡೆಯರ್',1766,1770,'src-wikipedia-nanjaraja-wodeyar'],
  ['chamaraja-wodeyar-viii','Chamaraja Wodeyar VIII','ಚಾಮರಾಜ ಒಡೆಯರ್ VIII',1770,1776,'src-wikipedia-chamaraja-wodeyar-ix'],
  ['chamaraja-wodeyar-ix','Chamaraja Wodeyar IX','ಚಾಮರಾಜ ಒಡೆಯರ್ IX',1776,1796,'src-wikipedia-chamaraja-wodeyar-ix'],
].map(([id,en,kn,from,to,sourceId])=>({
  id:`person-${id}`, name:name(en,kn), roles:['ruler'], polityId:'polity-mysore',
  date:dateRange(from,to,'range'),
  citations:[citation(sourceId,'Wadiyar succession chain, Chikka Devaraja to Krishnaraja Wadiyar III; discovery lead pending independent review')],
  review:review('needs-review'),
}))
mysoreWadiyarBridgePeople.forEach(person=>{
  const existing=atlasData.people.find(item=>item.id===person.id)
  if(existing) Object.assign(existing,person)
  else atlasData.people.push(person)
})
appendUniqueById(atlasData.people, [
  { id:'person-kumaravyasa', name:name('Kumaravyasa (Gadugina Veera Naranappa)','ಕುಮಾರವ್ಯಾಸ (ಗದುಗಿನ ವೀರನಾರಣಪ್ಪ)'), roles:['poet','author'], polityId:'polity-vijayanagara', date:dateRange(1400,1450,'circa'), citations:[citation('src-wikipedia-kumara-vyasa','Pen name of Gadugina Veera Naranappa; court poet under Deva Raya II; lived in Koliwad near Gadag; author of Karnata Bharata Kathamanjari (Kumaravyasa Bharata), completed 1430')], review:review('needs-review') },
  { id:'person-kumara-valmiki', name:name('Kumara Valmiki (Narahari)','ಕುಮಾರ ವಾಲ್ಮೀಕಿ (ನರಹರಿ)'), roles:['poet','author'], polityId:'polity-vijayanagara', date:dateRange(1500,1500,'circa'), citations:[citation('src-shastriyakannada-toraveya-ramayana','Pen name of Narahari; composed the Toraveya Ramayana from c. 1500 at the Narasimha temple, Torvi (Torave); influenced by Kumaravyasa')], review:review('needs-review') },
])
...
appendUniqueById(atlasData.polities, karnatakaArchaeologyMiningPolities)
...
const workEditionWitnessLinks={
  ...
  'work-ajitapurana':{manuscriptWitnesses:['manuscript-ajitapurana-jangamwadi-witness-lead'],citations:[citation('src-archive-ajitapurana-sannayya-ramagauda','N. Sannayya Rama Gauda edition, Jangamwadi Math Library Collection (item-level), freely downloadable')],dateOverride:{from:993,to:993,era:'CE',precision:'year'}},
  'work-shantipurana':{manuscriptWitnesses:['manuscript-shantipurana-jangamwadi-witness-lead'],citations:[citation('src-archive-shantipurana-vidyashankar','S. Vidyashankar edition, Priyadarshini Prakashan, CC0-licensed (item-level), freely downloadable')]},
}
...
atlasData.relationships = [
  ...
  ...atlasData.genealogicalRelations.map(item => ({ id:`rel-${item.id}`, fromId:item.fromPersonId, type:`genealogy-${item.relationKind}`, toId:item.toPersonId, date:item.date, citations:item.citations, review:item.review, sourceRecordId:item.id, evidenceLevel:item.evidenceLevel, confidence:item.confidence })),
  ...atlasData.coinRecords.flatMap(item => [
    { id:`rel-${item.id}-polity`, fromId:item.id, type:'coinage-of', toId:item.polityId, date:item.date, citations:item.citations, review:item.review },
    { id:`rel-${item.id}-place`, fromId:item.id, type:'coin-findspot-context', toId:item.placeId, date:item.date, citations:item.citations, review:item.review },
  ]),
  ...atlasData.manuscriptWitnesses.map(item => ({ id:`rel-${item.id}-work`, fromId:item.id, type:'manuscript-witness-for', toId:item.workId, date:item.date, citations:item.citations, review:item.review })),
  ...atlasData.boundaryEvidence.map(item => ({ id:`rel-${item.id}-extent`, fromId:item.id, type:'boundary-evidence-for', toId:item.extentId, date:item.date, citations:item.citations, review:item.review })),
  ...atlasData.inscriptionEditions.map(item => ({ id:`rel-${item.id}-inscription`, fromId:item.id, type:'edition-for-inscription', toId:item.inscriptionId, date:item.date, citations:item.citations, review:item.review })),
]
