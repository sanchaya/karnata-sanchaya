...
export const heritageDirectVerification={
  ...
  'candidate-uttara-kannada-1':{
    ...
    constructionPhases:[{name:n('Mahabaleshwar Temple tradition/reference date','ಮಹಾಬಲೇಶ್ವರ ದೇವಾಲಯದ ಪರಂಪರೆ/ಉಲ್ಲೇಖ ದಿನಾಂಕ'),date:{from:345,to:365,era:'CE',precision:'century'}}],protectionStatus:[],managingAuthorities:[],administrativeAreas:[],
    ...
    verificationNote:n('This point represents Mahabaleshwar Temple within the wider Gokarna temple landscape. The cited Wikipedia infobox dates completion to 345-365 CE under Mayuravarma/Mayurasharma of the Kadamba dynasty; retained as a reference claim, not a complete fabric chronology (much of the standing structure is later Vijayanagara-period work).','ಈ ಬಿಂದು ವಿಶಾಲ ಗೋಕರ್ಣ ದೇವಾಲಯ ಭೂದೃಶ್ಯದಲ್ಲಿನ ಮಹಾಬಲೇಶ್ವರ ದೇವಾಲಯವನ್ನು ಸೂಚಿಸುತ್ತದೆ. ಉಲ್ಲೇಖಿತ ವಿಕಿಪೀಡಿಯ ಮಾಹಿತಿಪೆಟ್ಟಿಗೆಯು ಕದಂಬ ಮಯೂರವರ್ಮ/ಮಯೂರಶರ್ಮನ ಕಾಲದಲ್ಲಿ 345-365 ಕ್ರಿ.ಶ.ದಲ್ಲಿ ಪೂರ್ಣಗೊಂಡಿತು ಎಂದು ದಾಖಲಿಸುತ್ತದೆ; ಇದನ್ನು ಆಕರದ ಹೇಳಿಕೆಯಾಗಿ ಉಳಿಸಲಾಗಿದೆ, ಸಂಪೂರ್ಣ ವಾಸ್ತುಕಾಲಕ್ರಮವಲ್ಲ (ಇಂದಿನ ಹೆಚ್ಚಿನ ರಚನೆ ನಂತರದ ವಿಜಯನಗರ ಕಾಲದ ಕಾಮಗಾರಿ).'),lastVerified:'2026-08-26'
  }
}
