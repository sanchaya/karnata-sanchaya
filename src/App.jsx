...
const publicDataDepth=(()=>{
  const historicalCollections=['events','people','works','inscriptions','culturalHeritage','periodicals','reigns','territorialExtents','politicalRelations','externalGovernancePhases','districtHistoryResearch']
...
function EventRail({locale,t,year,stories,selectedId,onSelect,onCategoryChange}){
  ...
  const timelineCategories=['all','wars','political','connections','people','literature','periodicals','inscriptions','temples','monuments','reigns','territory','culture']
...
export default function App(){
  ...
  const [layers,setLayers]=useState({boundaries:true,territorialReach:true,districts:true,heritageSites:true,culture:true,periodicals:true,temples:true,inscriptions:true,researchCandidates:true,events:true,people:true,modern:true})
  const [query,setQuery]=useState('')
