...
function EventRail({locale,t,year,stories,selectedId,onSelect,onCategoryChange}){
  ...
  const timelineCategories=['all','wars','political','connections','people','literature','periodicals','artifacts','inscriptions','temples','monuments','reigns','territory','culture']
