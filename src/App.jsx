...
export default function App(){
  ...
  return <div className="app-shell" lang={locale}>
    ...
    <nav id="primary-navigation" className={`portal-nav ${mobileNavOpen?'open':''}`} aria-label={t.primaryNavigation} onClick={()=>setMobileNavOpen(false)}>{primaryNavItems.map(item=>navLink(item))}{utilityNavItems.map(item=>navLink(item,'nav-utility-link'))}</nav>
