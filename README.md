...
Atlas v0.28.2 expands the P2/P3 maturity layer with Hoysala and Mysore genealogy bridges, Belur and Srirangapatna coinage leads, Kumaravyasa Bharata and Torave Ramayana Sanchaya witness leads, Hoysala and Mysore boundary-evidence packets, Shravanabelagola/Muktesvara/Hampi inscription-edition packets with locator-review worklists, a local Epigraphia Carnatica Archive TXT citation index, and six review-gated script-evolution phases from early Kadamba/Brahmi transition through Vijayanagara mixed-script evidence and modern print. The `#scripts` explorer makes these script-evolution records publicly navigable. These are discovery and review packets, not publication-ready claims.
