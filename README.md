...
Atlas v0.28.3 expands the P2/P3 maturity layer with Hoysala and Mysore genealogy bridges, Vengi and Tuluva-line proof packets, Belur/Srirangapatna/Maski/Hoysala coinage leads, Kumaravyasa Bharata, Torave Ramayana, Kavirajamarga and Shabdamanidarpana witness leads, Hoysala/Mysore/Chalukya/Keladi boundary-evidence packets, Shravanabelagola/Muktesvara/Hampi inscription-edition packets with locator-review worklists, a local Epigraphia Carnatica Archive TXT citation index, and twelve review-gated script-evolution phases. The `#scripts` explorer now shows full palaeographic classification fields for Ashokan/Satavahana Brahmi, Kadamba/Proto-Kannada, Badami Chalukya, Rashtrakuta, Kalyani Chalukya-Hoysala, Vijayanagara-Nayaka/Telugu-Kannada divergence and Mysore/modern print Kannada. These are discovery and review packets, not publication-ready claims.
