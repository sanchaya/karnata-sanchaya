...
test('the Epigraphy Explorer exposes the P2 corpus review queue', () => {
  ...
  assert.match(explorerSource, /ItihasaDarshanaCorpus/, 'the epigraphy page must expose linked Itihasa Darshana review leads')
  assert.match(explorerSource, /atlasLinks/, 'Itihasa Darshana volumes must surface atlas link groups')
